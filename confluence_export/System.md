...
In rare cases, it may be necessary to delete the IP Fabric's database.
Go to ***Settings → Advanced →*** ***System ***and click ***Clear DB***.

Discovery data will be lost and the system setting will be reset to
defaults <u>except</u>:
