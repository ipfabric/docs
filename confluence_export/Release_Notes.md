...
-   Changes in POST `/snapshots` endpoint - the snapshot "name" and
    "note" can be set now
...
-   API for pathlookup has changed see API Documetation [API Tech Note -
    IP Fabric 4.x Unicast Path
    Lookup](https://ipfabric.atlassian.net/wiki/spaces/ND/pages/2785640457/API+Tech+Note+-+IP+Fabric+4.x+Unicast+Path+Lookup)
