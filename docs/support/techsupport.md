...
1. In the IP Fabric GUI, go to **Support --> Generate Techsupport**:
   ...
   ![Generate techsupport file](../images/support/techsupport/support-techsupport-images_techsupport_generation-20250307.png)

2. Select the data to be included in the techsupport file (when in doubt, keep
   the defaults):

   ![Configure what to include in techsupport file](../images/support/techsupport/support-techsupport-images_techsupport_generation_settings-20250307.png)
...
![Upload techsupport file](../images/support/techsupport/support-techsupport-images_upload.png)
