...
1. In the IP Fabric GUI, go to **Support --> Generate Techsupport**:
   ...
   ![Generate techsupport file](../images/support/techsupport/support-techsupport_techsupport-generation-20250307.webp)

2. Select the data to be included in the techsupport file (when in doubt, keep
   the defaults):

   ![Configure what to include in techsupport file](../images/support/techsupport/support-techsupport_techsupport-generation-settings-20250307.webp)
...
![Upload techsupport file](../images/support/techsupport/support-techsupport_upload.webp)
