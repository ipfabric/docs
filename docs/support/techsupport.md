...
1. In the IP Fabric GUI, go to **Support --> Generate Techsupport**:
   ...
   ![Generate techsupport file](techsupport-images/techsupport_generation-20250307.webp)

2. Select the data to be included in the techsupport file (when in doubt, keep
   the defaults):

   ![Configure what to include in techsupport file](techsupport-images/techsupport_generation_settings-20250307.webp)
...
![Upload techsupport file](techsupport-images/upload.webp)
