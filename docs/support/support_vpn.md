...
2. Select **Remote support VPN**:
   ...
   ![Select Remote support VPN in Support menu](vpn/menu.webp)

3. On the newly opened page, click **Connect**:

   ![Remote support over VPN - Connect](vpn/connect.webp)
...
3. Now run the VPN command:
   ...
   ![Start VPN from CLI](vpn/cli_vpn_connect.webp)
...
2. On the newly opened page, click **Disconnect**:
   ...
   ![Remote support over VPN - Disconnect](vpn/disconnect.webp)
...
2. Now run the VPN command:
   ...
   ![Stop VPN from CLI](vpn/cli_vpn_disconnect.webp)
