...
!!! example "Disk benchmark example"
    ...
    ![Example disk benchmark output](ipf_checker_disk_benchmark.webp){ align=left }
...
!!! example "Results table example"
    ...
    ![Example ipf-chekcer output](ipf_checker_full_table_pt1.webp){ align=left }

    ![Example ipf-chekcer output](ipf_checker_full_table_pt2.webp){ align=left }
...
!!! info "Token generation"
    ...
    ![Example token geneartion](ipf_checker_token.webp)
