...
3. Select `Yes` to proceed:
   ...
   ![Do you want to set admin user password?](../../images/settings/System_Administration-IPF_CLI_Config_gui_admin_password_change.png){: width="500" .center}

4. Enter the new `admin` password twice:

   ![Enter admin user password](../../images/settings/System_Administration-IPF_CLI_Config_gui_admin_password_change2.png){: width="600" .center}

   ![Repeat admin user password](../../images/settings/System_Administration-IPF_CLI_Config_gui_admin_password_change3.png){: width="600" .center}
  ...
  !!! Info
      ...
      ![Retry setting an admin password](../../images/settings/System_Administration-IPF_CLI_Config_gui_admin_password_change4.png){: width="500" .center}

5. Select `No` to prevent rebooting the system.

   ![Do not reboot the system](../../images/settings/System_Administration-IPF_CLI_Config_gui_admin_password_change5.png){: width="500" .center}
