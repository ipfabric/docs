...
3. Modify the hostname -- the very first option:
  ...
  ![Enter the short hostname](../../images/settings/System_Administration-IPF_CLI_Config_change_hostname2.webp)
...
4. Modify the DNS domain name -- the second option:
  ...
  ![Enter the DNS domain name](../../images/settings/System_Administration-IPF_CLI_Config_change_dns_domain_name.webp)
