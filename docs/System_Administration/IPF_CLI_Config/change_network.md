...
4. Next, select DHCP or static IP address assignment. Use the `up`/`down` and
   ...
   ![Use DHCP or Static IP Address](../../images/settings/System_Administration-IPF_CLI_Config_change_ip_assignment.png)
...
5. If you selected static IP address assignment, then enter:
   ...
   ![Configure a static IP](../../images/settings/System_Administration-IPF_CLI_Config_change_static_ip.png)

6. Next, answer if you want to configure IPv6 network

   ![IPv6 configuration question](../../images/settings/System_Administration-IPF_CLI_Config_question_ipv6.png)

7. If you chose to configure IPv6 network, select IPv6 configuration type.
   Use the `up`/`down` and `Space` keys to change `()` to `(*)`.

   ![IPv6 configuration type](../../images/settings/System_Administration-IPF_CLI_Config_change_ipv6_configuration_type.png)
...
8. If you selected `static` IPv6 configuration, then enter
   ...
   ![Configure a static IPv6](../../images/settings/System_Administration-IPF_CLI_Config_change_static_ipv6.png)
...
9. If you selected `auto` IPv6 configuration, then answer if you want to run
   ...
   ![Run RDNSSD question](../../images/settings/System_Administration-IPF_CLI_Config_question_rdnssd.png)
...
10. Next, insert IP addresses of DNS resolvers. If you chose to use IPv6,
   ...
   ![Configure DNS resorvers](../../images/settings/System_Administration-IPF_CLI_Config_change_dns_resolvers.png)

11. Confirm or change FQDN which will be resolved during DNS tests.

   ![Configure FQDN for DNS tests](../../images/settings/System_Administration-IPF_CLI_Config_change_dns_test_fqdn.png)
