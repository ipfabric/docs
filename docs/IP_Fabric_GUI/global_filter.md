...
![Attribute filter](../images/miscellaneous/global_filter_attribute/IP_Fabric_GUI-global_filter_attribute_filter.webp)
...
![Select attribute](../images/miscellaneous/global_filter_attribute/IP_Fabric_GUI-global_filter_select_attribute.webp)
...
![Select attribute](../images/miscellaneous/global_filter_attribute/IP_Fabric_GUI-global_filter_attribute_filter_disabled.webp)

In this example, we are filtering on `siteName` with the value `35COLO`.

![Select value(s) for siteName](../images/miscellaneous/global_filter_attribute/IP_Fabric_GUI-global_filter_select_values_for_sitename.webp)
