...
![Attribute filter](../images/miscellaneous/global_filter_attribute/miscellaneous-global-filter-attribute_attribute-filter.webp)
...
![Select attribute](../images/miscellaneous/global_filter_attribute/miscellaneous-global-filter-attribute_select-attribute.webp)
...
![Select attribute](../images/miscellaneous/global_filter_attribute/miscellaneous-global-filter-attribute_attribute-filter-disabled.webp)

In this example, we are filtering on `siteName` with the value `35COLO`.

![Select value(s) for siteName](../images/miscellaneous/global_filter_attribute/miscellaneous-global-filter-attribute_select-values-for-sitename.webp)

In **Inventory --> Devices**, we can see that the **Device Inventory** table is
filtered to show only devices from the Site `35COLO`.

![siteName 35COLO selected](../images/miscellaneous/global_filter_attribute/miscellaneous-global-filter-attribute_sitename-selected.webp)

![Attribute filter for siteName 35COLO applied](../images/inventory/devices/inventory-devices_global-filter-attribute-filter-applied.webp)
