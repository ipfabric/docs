...
![Invalid Input](../../images/miscellaneous/ipf/miscellaneous-ipf_vague-messages-invalid-input.webp)
...
![Web Developer Tools in Firefox](../../images/miscellaneous/ipf/miscellaneous-ipf_vague-messages-f12-firefox.webp)
...
![Response tab](../../images/miscellaneous/ipf/miscellaneous-ipf_vague-messages-response.webp)
...
!!! example
    ...
    ![Jumphost example](../../images/settings/discovery-snapshots/settings-discovery-snapshots_example.webp)
