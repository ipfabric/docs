...
![Config Credentials](../../images/management/configuration/management-configuration_config-auth.webp)
...
![Configuration table example](../../images/management/configuration/management-configuration_config-table-example.webp)
...
![Selecting configs for comparison](../../images/management/configuration/management-configuration_config-select-compare.webp)

There is also a shortcut for comparing configurations directly with their previous state by clicking this button instead:

![alt text](../../images/management/configuration/management-configuration_config-quick-comparison.webp)
...
<figure markdown>
  ![Side by side](../../images/management/configuration/management-configuration_config-side-by-side.webp)
  <figcaption>Side by side</figcaption>
</figure>

<figure markdown>
  ![Inline](../../images/management/configuration/management-configuration_config-inline.webp)
  <figcaption>Inline</figcaption>
</figure>

<figure markdown>
  ![Inline diff](../../images/management/configuration/management-configuration_config-inline-diff.webp)
