...
When you go to the page **_Diagrams → Network_**, all networks are
...
For example, to see a diagram of particular sites called _66 Ostrava DC_
and _47 Brno Warehouse_:
...
![](network_viewer/button_center_view.png)
...
![](network_viewer/set_user_defined_layout_as_default.png)

From now on, this will be the default layout for this site:

![](network_viewer/network_default_user_defined_layout.png)
