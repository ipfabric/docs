...
![Network Viewer - All network](network_viewer/all_network.webp)
...
![Networks selected to show](network_viewer/networks_selected_to_show.webp)
...
![Center View button](network_viewer/button_center_view.webp)
...
1. collapse the selected items into a new cloud:
   ...
   ![Collapse selected nodes](network_viewer/collapse_selected_nodes.webp)

   ![Selected nodes collapsed](network_viewer/collapse_selected_nodes_done.webp)


2. or hide them:

   ![Hide selected nodes](network_viewer/hide_selected_nodes.webp)

   ![Selected nodes hidden](network_viewer/hide_selected_nodes_done.webp)
...
![Save user-defined or choose another layout](network_viewer/button_save_user_defined_1.webp)

![Save user-defined layout](network_viewer/button_save_user_defined_2.webp)
...
![Set default user layout](network_viewer/set_user_defined_layout_as_default_1.webp)

![Set default user layout](network_viewer/set_user_defined_layout_as_default_2.webp)

From now on, this will be the default layout for this site:

![Default user defined layout](network_viewer/network_default_user_defined_layout.webp)

### Choose a Specific Layout for a Selection of Devices

You can now specify which layout you want to use for a set of devices:

![Use specific layout for selected devices](network_viewer/specific_layout_for_selected_devices.webp)
...
![Change diagram layout for site](network_viewer/change_diagram_layout_for_site.webp)
...
![Save View](network_viewer/button_save_view.webp)
...
![Select View](network_viewer/button_select_view.webp)
...
![Share View](network_viewer/button_share_view.webp)
...
![Export button](network_viewer/button_export.webp)

![Expanded Export menu](network_viewer/export_menu_expanded.webp){ width=300 }
...
![Search diagram](network_viewer/button_search_diagram.webp)

![Search diagram results](network_viewer/search_diagram_results.webp)

If you hover the mouse cursor on one entry, you will see the device on the
diagram:

![Hover over search diagram results](network_viewer/search_diagram_results_hover.webp)
...
![Protocols - Visualization setup](network_viewer/protocols_visualization_setup.webp)
...
![Configure visualization setup](network_viewer/visualization_setup_settings.webp)
...
![Drag and drop protocol](network_viewer/protocols_drag_drop.webp)

With the example below, you are now able to hide only the DGW protocol
without affecting the other Layer 3 protocols:

![Hide protocol](network_viewer/protocols_hide_dgw.webp)
...
![VRF labels](network_viewer/protocols_vrf_labels.webp)

### Link Grouping

![Link grouping](network_viewer/protocols_link_grouping.webp)
...
![Layer grouping](network_viewer/protocols_layer_grouping.webp)
...
![Select type of devices to see](network_viewer/select_device_type.webp)
...
![Device - Explore](network_viewer/device_explore.webp)
