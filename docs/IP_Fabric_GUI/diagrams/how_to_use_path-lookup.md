...
![First hop algorithm](../../images/diagrams/IP_Fabric_GUI-diagrams-pathlookup_first_hop_algorithm.webp)
...
!!! Example "User-Defined First Hop Algorithm"
    ...
    ![User Defined First hop algorithm example](../../images/diagrams/IP_Fabric_GUI-diagrams-pathlookup_user_defined_first_hop_algorithm_example_drawing.webp){: style="height:150px"}
    ...
    ![User Defined First hop algorithm](../../images/diagrams/IP_Fabric_GUI-diagrams-pathlookup_user_defined_first_hop_algorithm.webp)

    This is the result you will get:

    ![User Defined First hop algorithm Result](../../images/diagrams/IP_Fabric_GUI-diagrams-pathlookup_user_defined_first_hop_algorithm_result.webp)
...
![Source and destination](../../images/diagrams/IP_Fabric_GUI-diagrams-pathlookup_pathlookup_src_dst.webp)

When switched to `Web HTTP/HTTPS`, TCP destination ports `80` and `443` with the `(web|http|https)` application are set by default.

![HTTP default](../../images/diagrams/IP_Fabric_GUI-diagrams-pathlookup_pathlookup_http_default.webp)
...
![Source and destination ports](../../images/diagrams/IP_Fabric_GUI-diagrams-pathlookup_pathlookup_src_dst_port.webp)
...
![TTL and Fragmentation](../../images/diagrams/IP_Fabric_GUI-diagrams-pathlookup_pathlookup_ttl_fragment.webp)
...
![Application](../../images/diagrams/IP_Fabric_GUI-diagrams-pathlookup_pathlookup_application.webp)
...
![Regions](../../images/diagrams/IP_Fabric_GUI-diagrams-pathlookup_pathlookup_src_dst_regions.webp)
...
![Path lookup example](../../images/diagrams/IP_Fabric_GUI-diagrams-pathlookup_example.webp)

### Security Rules

![Path lookup drop](../../images/diagrams/IP_Fabric_GUI-diagrams-pathlookup_pathlookup_drop.webp)

If **Drop** is selected, the path lookup will stop when a security rule denies
traffic.

![Path lookup continue](../../images/diagrams/IP_Fabric_GUI-diagrams-pathlookup_pathlookup_continue.webp)
...
![IPsec connection overlapping with existing connections](../../images/diagrams/IP_Fabric_GUI-diagrams_ipsec_edge_overlapping.webp){ width="473" .center}

To resolve this, move the middle device to a different position:

![IPsec connection overlapping resolved by moving device](../../images/diagrams/IP_Fabric_GUI-diagrams_ipsec_edge_overlapping_resolved.webp){ width="473" .center}
...
![Multicast form](../../images/diagrams/IP_Fabric_GUI-diagrams-pathlookup_multicast.webp)

You will then see the Multicast Tree:

![Multicast example](../../images/diagrams/IP_Fabric_GUI-diagrams-pathlookup_multicast_example.webp)

And you will have access to a lot of information regarding the Multicast
forwarding decision:

![Multicast path inspector](../../images/diagrams/IP_Fabric_GUI-diagrams-pathlookup_multicast_path_inspector.webp)
...
![Path controls](../../images/diagrams/IP_Fabric_GUI-diagrams-pathlookup_path_controls.webp)

After opening the details with `Explore`, you can select the destination link to proceed with packet analysis:

![Path detail](../../images/diagrams/IP_Fabric_GUI-diagrams-pathlookup_path_detail.webp)
...
![Forwarding decision](../../images/diagrams/IP_Fabric_GUI-diagrams-pathlookup_forwarding_decision.webp)

In this example, we are looking at the device `L21C11`, which has 2
incoming interfaces and one forwarding for this flow:

![Forwarding decision animation](../../images/diagrams/IP_Fabric_GUI-diagrams-pathlookup_forwarding_decision_animation.webp)
...
![Visualization setup](../../images/diagrams/IP_Fabric_GUI-diagrams-pathlookup_visualization_setup_movable.webp)
