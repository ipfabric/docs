...
![Unicast form](../../images/diagrams/diagrams_pathlookup-unicast.webp)
...
![First hop algorithm](../../images/diagrams/diagrams_pathlookup-first-hop-algorithm.webp)
...
!!! Example "User-Defined First Hop Algorithm"
    ...
    ![User Defined First hop algorithm example](../../images/diagrams/diagrams_pathlookup-user-defined-first-hop-algorithm-example-drawing.webp){: style="height:150px"}
    ...
    ![User Defined First hop algorithm](../../images/diagrams/diagrams_pathlookup-user-defined-first-hop-algorithm.webp)

    This is the result you will get:

    ![User Defined First hop algorithm Result](../../images/diagrams/diagrams_pathlookup-user-defined-first-hop-algorithm-result.webp)
...
![Source and destination](../../images/diagrams/diagrams_pathlookup-src-dst.webp)

When switched to `Web HTTP/HTTPS`, TCP destination ports `80` and `443` with the `(web|http|https)` application are set by default.

![HTTP default](../../images/diagrams/diagrams_pathlookup-http-default.webp)
...
![Source and destination ports](../../images/diagrams/diagrams_pathlookup-src-dst-port.webp)
...
![TTL and Fragmentation](../../images/diagrams/diagrams_pathlookup-ttl-fragment.webp)
...
![Application](../../images/diagrams/diagrams_pathlookup-application.webp)
...
![Regions](../../images/diagrams/diagrams_pathlookup-src-dst-regions.webp)
...
![Path lookup example](../../images/diagrams/diagrams_pathlookup-example.webp)

### Security Rules

![Path lookup drop](../../images/diagrams/diagrams_pathlookup-drop.webp)

If **Drop** is selected, the path lookup will stop when a security rule denies
traffic.

![Path lookup continue](../../images/diagrams/diagrams_pathlookup-continue.webp)
...
![IPsec connection overlapping with existing connections](../../images/diagrams/diagrams_ipsec-edge-overlapping.webp){ width="473" .center}

To resolve this, move the middle device to a different position:

![IPsec connection overlapping resolved by moving device](../../images/diagrams/diagrams_ipsec-edge-overlapping-resolved.webp){ width="473" .center}
...
![Multicast form](../../images/diagrams/diagrams_pathlookup-multicast.webp)

You will then see the Multicast Tree:

![Multicast example](../../images/diagrams/diagrams_pathlookup-multicast-example.webp)

And you will have access to a lot of information regarding the Multicast
forwarding decision:

![Multicast path inspector](../../images/diagrams/diagrams_pathlookup-multicast-path-inspector.webp)
...
![Host To Gateway form](../../images/diagrams/diagrams_pathlookup-host-to-gw.webp)
...
![Path controls](../../images/diagrams/diagrams_pathlookup-path-controls.webp)

After opening the details with `Explore`, you can select the destination link to proceed with packet analysis:

![Path detail](../../images/diagrams/diagrams_pathlookup-path-detail.webp)
...
![Forwarding decision](../../images/diagrams/diagrams_pathlookup-forwarding-decision.webp)

In this example, we are looking at the device `L21C11`, which has 2
incoming interfaces and one forwarding for this flow:

![Forwarding decision animation](../../images/diagrams/diagrams_pathlookup-forwarding-decision-animation.webp)
