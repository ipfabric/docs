...
If you want to learn more about how network discovery works from a technical point of view, read [How CLI Discovery Works](../Getting_Started/Overview/How_Discovery_Works/CLI_discovery.md) and [How API Discovery Works](../Getting_Started/Overview/How_Discovery_Works/API_discovery.md).
