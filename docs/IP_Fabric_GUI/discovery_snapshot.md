...
![Current Snapshot](../images/snapshot-management/snapshot-management_current-snapshot.webp)

## New Snapshot

![New snapshot](../images/snapshot-management/snapshot-management_new-snapshot.webp)
...
![Snapshot-specific settings](../images/snapshot-management/settings/snapshot-management-settings_snapshot_specific_settings.webp)

![Snapshot-specific settings](../images/snapshot-management/settings/snapshot-management-settings_snapshot_settings.webp)
...
![Snapshot versus software version](../images/snapshot-management/snapshot-management_snapshot-versus-software-version.webp)
...
![Discovery Connectivity Report](../images/snapshot-management/errors/snapshot-management-errors_discovery-connectivity-report.webp)

![Discovery Connectivity Report](../images/snapshot-management/errors/snapshot-management-errors_discovery-connectivity-report-logs.webp)

## Modifying Snapshot Devices

### Adding Devices

![Add Devices button](../images/snapshot-management/snapshot-management_snapshot-add-devices-button.webp)

![Add Devices dialog](../images/snapshot-management/snapshot-management_snapshot-add-device.webp)
...
![Select devices to refresh](../images/snapshot-management/snapshot-management_snapshot-refresh-device-select.webp)

![Refresh Devices button](../images/snapshot-management/snapshot-management_snapshot-refresh-device.webp)
...
![Select devices to delete](../images/snapshot-management/snapshot-management_snapshot-delete-device-select.webp)

![Delete Devices button](../images/snapshot-management/snapshot-management_snapshot-delete-device.webp)
...
![Lock snapshot](../images/snapshot-management/snapshot-management_snapshot-lock.webp)
...
![Unload snapshot](../images/snapshot-management/snapshot-management_snapshot-unload.webp)
...
![Load snapshot](../images/snapshot-management/snapshot-management_snapshot-load.webp)
...
![Download snapshot](../images/snapshot-management/snapshot-management_snapshot-download.webp)

If needed, a selected snapshot can be downloaded from IP Fabric to your local storage by selecting `Download snapshot`.

### Clone Snapshot

![Clone snapshot](../images/snapshot-management/snapshot-management_snapshot-clone.webp)
...
![Delete snapshot](../images/snapshot-management/snapshot-management_snapshot-delete.webp)

Snapshots can be deleted using `Delete snapshot`.

## Load Snapshot From File

![Load From File](../images/snapshot-management/snapshot-management_snapshot-load-from-file.webp)
