...
![Current Snapshot](../images/snapshot-management/IP_Fabric_GUI-snapshots_current_snapshot.webp)

## New Snapshot

![New snapshot](../images/snapshot-management/IP_Fabric_GUI-snapshots_new_snapshot.webp)
...
![Discovery Stop](../images/snapshot-management/IP_Fabric_GUI-snapshots_discovery_stop.webp)
...
![Discovery Stopping](../images/snapshot-management/IP_Fabric_GUI-snapshots_discovery_stopping.webp)
...
![Discovery Force Stop](../images/snapshot-management/IP_Fabric_GUI-snapshots_discovery_force_stop.webp)
...
![Discovery Force Stopped](../images/snapshot-management/IP_Fabric_GUI-snapshots_discovery_force_stopped.webp)
...
![Snapshot versus software version](../images/snapshot-management/IP_Fabric_GUI-snapshots_snapshot_versus_software_version.webp)
...
![Add Devices button](../images/snapshot-management/IP_Fabric_GUI-snapshots_snapshot_add_devices_button.webp)

![Add Devices dialog](../images/snapshot-management/IP_Fabric_GUI-snapshots_snapshot_add_device.webp)
...
![Select devices to refresh](../images/snapshot-management/IP_Fabric_GUI-snapshots_snapshot_refresh_device_select.webp)

![Refresh Devices button](../images/snapshot-management/IP_Fabric_GUI-snapshots_snapshot_refresh_device.webp)
...
![Select devices to delete](../images/snapshot-management/IP_Fabric_GUI-snapshots_snapshot_delete_device_select.webp)

![Delete Devices button](../images/snapshot-management/IP_Fabric_GUI-snapshots_snapshot_delete_device.webp)
...
![Lock snapshot](../images/snapshot-management/IP_Fabric_GUI-snapshots_snapshot_lock.webp)
...
![Unload snapshot](../images/snapshot-management/IP_Fabric_GUI-snapshots_snapshot_unload.webp)
...
![Load snapshot](../images/snapshot-management/IP_Fabric_GUI-snapshots_snapshot_load.webp)
...
![Download snapshot](../images/snapshot-management/IP_Fabric_GUI-snapshots_snapshot_download.webp)

If needed, a selected snapshot can be downloaded from IP Fabric to your local storage by selecting `Download snapshot`.

### Clone Snapshot

![Clone snapshot](../images/snapshot-management/IP_Fabric_GUI-snapshots_snapshot_clone.webp)
...
![Delete snapshot](../images/snapshot-management/IP_Fabric_GUI-snapshots_snapshot_delete.webp)

Snapshots can be deleted using `Delete snapshot`.

## Load Snapshot From File

![Load From File](../images/snapshot-management/IP_Fabric_GUI-snapshots_snapshot_load_from_file.webp)
