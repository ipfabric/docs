...
![Current Snapshot](../images/snapshot-management/IP_Fabric_GUI-snapshots_current_snapshot.png)

## New Snapshot

![New snapshot](../images/snapshot-management/IP_Fabric_GUI-snapshots_new_snapshot.png)
...
![Discovery Stop](../images/snapshot-management/IP_Fabric_GUI-snapshots_discovery_stop.png)
...
![Discovery Stopping](../images/snapshot-management/IP_Fabric_GUI-snapshots_discovery_stopping.png)
...
![Discovery Force Stop](../images/snapshot-management/IP_Fabric_GUI-snapshots_discovery_force_stop.png)
...
![Discovery Force Stopped](../images/snapshot-management/IP_Fabric_GUI-snapshots_discovery_force_stopped.png)

## Snapshot-Specific Settings

![Snapshot-specific settings](../images/snapshot-management/IP_Fabric_GUI-snapshots_snapshot_specific_settings.png)

![Snapshot-specific settings](../images/snapshot-management/IP_Fabric_GUI-snapshots_snapshot_settings.png)
...
![Snapshot versus software version](../images/snapshot-management/IP_Fabric_GUI-snapshots_snapshot_versus_software_version.png)
...
![Discovery Connectivity Report](../images/snapshot-management/IP_Fabric_GUI-snapshots_discovery_connectivity_report.png)

![Discovery Connectivity Report](../images/snapshot-management/IP_Fabric_GUI-snapshots_discovery_connectivity_report_logs.png)

## Modifying Snapshot Devices

### Adding Devices

![Add Devices button](../images/snapshot-management/IP_Fabric_GUI-snapshots_snapshot_add_devices_button.png)

![Add Devices dialog](../images/snapshot-management/IP_Fabric_GUI-snapshots_snapshot_add_device.png)
...
![Select devices to refresh](../images/snapshot-management/IP_Fabric_GUI-snapshots_snapshot_refresh_device_select.png)

![Refresh Devices button](../images/snapshot-management/IP_Fabric_GUI-snapshots_snapshot_refresh_device.png)
...
![Select devices to delete](../images/snapshot-management/IP_Fabric_GUI-snapshots_snapshot_delete_device_select.png)

![Delete Devices button](../images/snapshot-management/IP_Fabric_GUI-snapshots_snapshot_delete_device.png)
...
![Lock snapshot](../images/snapshot-management/IP_Fabric_GUI-snapshots_snapshot_lock.png)
...
![Unload snapshot](../images/snapshot-management/IP_Fabric_GUI-snapshots_snapshot_unload.png)
...
![Load snapshot](../images/snapshot-management/IP_Fabric_GUI-snapshots_snapshot_load.png)
...
![Download snapshot](../images/snapshot-management/IP_Fabric_GUI-snapshots_snapshot_download.png)

If needed, a selected snapshot can be downloaded from IP Fabric to your local storage by selecting `Download snapshot`.

### Clone Snapshot

![Clone snapshot](../images/snapshot-management/IP_Fabric_GUI-snapshots_snapshot_clone.png)
...
![Delete snapshot](../images/snapshot-management/IP_Fabric_GUI-snapshots_snapshot_delete.png)

Snapshots can be deleted using `Delete snapshot`.

## Load Snapshot From File

![Load From File](../images/snapshot-management/IP_Fabric_GUI-snapshots_snapshot_load_from_file.png)
