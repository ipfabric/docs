...
![Technology table showing Vendors](../../../images/technology/cloud/IP_Fabric_GUI-technology_tables-cloud_vendors.webp){: width="200" .center}

## AWS

AWS's inventory table offers the Amazon Resource Name (ARN), resource type, resource ID, owner ID, and region.

![Technology table showing GCP Inventory](../../../images/technology/cloud/IP_Fabric_GUI-technology_tables-cloud_vendors-aws_inventory.webp)
...
![Technology table showing AWS Scaling Groups](../../../images/technology/cloud/IP_Fabric_GUI-technology_tables-cloud_vendors-aws_scaling_groups.webp)
...
![Technology table showing AWS subnets](../../../images/technology/cloud/IP_Fabric_GUI-technology_tables-cloud_vendors-aws_subnets.webp)
...
![Technology table showing VCP Endpoints](../../../images/technology/cloud/IP_Fabric_GUI-technology_tables-cloud_vendors-aws_private-link_endpoints.webp)

## Azure

Azure's Inventory table provides the serial number, subscription ID, subscription name, resource group, location, and SKU.

![Technology table showing Azure Inventory](../../../images/technology/cloud/IP_Fabric_GUI-technology_tables-cloud_vendors-azure_inventory.webp)
...
![Technology table showing Azure Virtual Machine Scale Sets](../../../images/technology/cloud/IP_Fabric_GUI-technology_tables-cloud_vendors-azure_virtual_machine_scale_sets.webp)
...
![Technology table showing Azure subnets](../../../images/technology/cloud/IP_Fabric_GUI-technology_tables-cloud_vendors-azure_subnets.webp)
...
![Technology table showing Azure Service Endpoints](../../../images/technology/cloud/IP_Fabric_GUI-technology_tables-cloud_vendors-azure_service_endpoints.webp)
...
![Technology table showing Azure Private Link](../../../images/technology/cloud/IP_Fabric_GUI-technology_tables-cloud_vendors-azure_private_link.webp)
...
![Technology table showing Azure VNet Integration](../../../images/technology/cloud/IP_Fabric_GUI-technology_tables-cloud_vendors-azure_vnet_integration.webp)
...
![Technology table showing Azure DNS Configuration](../../../images/technology/cloud/IP_Fabric_GUI-technology_tables-cloud_vendors-azure_dns_vnet.webp)
![Technology table showing Azure DNS Private Resolvers](../../../images/technology/cloud/IP_Fabric_GUI-technology_tables-cloud_vendors-azure_dns_private_resolver.webp)
![Technology table showing Azure DNS Private Resolvers Endpoints](../../../images/technology/cloud/IP_Fabric_GUI-technology_tables-cloud_vendors-azure_dns_resolvers_endpoints.webp)
![Technology table showing Azure DNS Forwarding Rulesets](../../../images/technology/cloud/IP_Fabric_GUI-technology_tables-cloud_vendors-azure_dns_forwarding_rulesets.webp)
![Technology table showing Azure DNS Forwarding Rules](../../../images/technology/cloud/IP_Fabric_GUI-technology_tables-cloud_vendors-azure_dns_forwarding_rulesets_rules.webp)

## GCP (Google Cloud Platform)

Google Cloud Platform's Inventory table contains the full resource name, project, and region.

![Technology table showing GCP Inventory](../../../images/technology/cloud/IP_Fabric_GUI-technology_tables-cloud_vendors-gcp_inventory.webp)
...
![Technology table showing GCP Instance & Network Endpoint Groups](../../../images/technology/cloud/IP_Fabric_GUI-technology_tables-cloud_vendors-gcp_instance_network_endpoint_groups.webp)
...
![Technology table showing GCP Subnets](../../../images/technology/cloud/IP_Fabric_GUI-technology_tables-cloud_vendors-gcp_subnets.webp)
...
![Technology table showing GCP Published Services in Private Service Connect](../../../images/technology/cloud/IP_Fabric_GUI-technology_tables-cloud_vendors-gcp_private-service-connect.webp)
...
![Technology table showing GCP Serverless Services](../../../images/technology/cloud/IP_Fabric_GUI-technology_tables-cloud_vendors-gcp_serverless-services.webp)
