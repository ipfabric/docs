...
The Instance & Network Endpoint Groups table contains details about managed and unmanaged instance groups and network endpoint groups, including names, IDs, states, number of virtual machines (where available/applicable), instance types (where available/applicable), types of groups, lists of endpoints in the groups, zones, regions, minimum and maximum numbers of endpoints in the groups, and auto-scaling information.
