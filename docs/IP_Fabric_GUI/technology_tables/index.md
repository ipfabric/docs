...
![Device Filters](../../images/technology/technology_table-device-filters.webp){ width=250 .center }
...
1. **Open the target table:** Navigate to any table where you want to use **Device-based advanced filters**. Click the `...` menu to access **Table Description**.  
   ![Table Description](../../images/rapidoc/rapidoc_advanced-filtering-navigate-to-table-desc.webp){ width="500" .center } 
2. **Access API documentation:** Scroll down and select **API Documentation**.  
   ![API Documentation](../../images/rapidoc/rapidoc_advanced-filtering-navigate-to-rapidoc.webp){ width="500" .center } 
3. **Review applicable filters:** Switch to the **Schema** tab to view all available filters for the selected table.  
   ![Schema](../../images/rapidoc/rapidoc_advanced-filtering-switch-to-schema.webp){ width="500" .center } 
...
![Table description](../../images/technology/technology_table-description-option.webp){ .center }

Hover the mouse cursor over a column header for the column's description:

![On-hover tooltip](../../images/miscellaneous/tips_tricks/filters_related_images/miscellaneous-tips-tricks-filters-related-images_table-onhover.webp){ .center }
...
![Display settings](../../images/miscellaneous/tips_tricks/three_dot_menu/miscellaneous-tips-tricks-three-dot-menu_table-display-settings-option.webp){ .center }
...
![Auto size](../../images/miscellaneous/tips_tricks/miscellaneous-tips-tricks_table-auto-size.webp){ .center }
...
![Restore table settings](../../images/miscellaneous/tips_tricks/three_dot_menu/miscellaneous-tips-tricks-three-dot-menu_table-restore.webp){ .center }

## Regular Expression Syntax

Regular expressions are evaluated in the PostgreSQL using the POSIX standard with some extensions.
Detailed information can be found in the [Regular Expression Details](https://www.postgresql.org/docs/15/functions-matching.html#FUNCTIONS-POSIX-REGEXP:~:text=9.7.3.1.%C2%A0Regular%20Expression%20Details)
section of the PostgreSQL documentation.

For a quick introduction to regular expressions, refer to [Regular Expressions Quick Start](https://www.regular-expressions.info/quickstart.html)
guide on [Regular-Expressions.info](https://www.regular-expressions.info/).
...
![Share URL options for tables](../../images/technology/technology_table-share-url-options.webp){ .center }
...
![Pin a page](../../images/technology/platforms/technology-platforms_page-pin.webp){ width="250" .center }
...
![Unpin a page](../../images/technology/platforms/technology-platforms_page-unpin.webp){ width="250" .center }
