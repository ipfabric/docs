...
![LISP IPv4 Routes table](../../images/technology/routing/IP_Fabric_GUI-technology_tables-lisp_lisp-routes-ipv4.webp)

The **Map Resolvers** tab contains a list of references to database servers which house the `EID/RLOC` mappings.

![LISP IPv4 Map Resolvers table](../../images/technology/routing/IP_Fabric_GUI-technology_tables-lisp_lisp-routes-mapResolver-ipv4.webp)
