...
![LISP IPv4 Routes table](../../images/technology/routing/technology-routing_lisp-routes-ipv4.webp)

The **Map Resolvers** tab contains a list of references to database servers which house the `EID/RLOC` mappings.

![LISP IPv4 Map Resolvers table](../../images/technology/routing/technology-routing_lisp-routes-map-resolver-ipv4.webp)
