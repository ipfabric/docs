...
![Dashboard](../images/dashboard/dashboard_dashboard.webp)
...
11. Select view type (summary table or graph). 
    ![Select Widget](../images/dashboard/dashboard_dashboard-select-widget.webp)
12. Click **Save** in the top-right corner.

And here is the new dashboard widget:

![New dashboard widget](../images/dashboard/dashboard_new-dashboard-widget.webp)
