...
[Create Snapshots Periodically](../settings/Discovery_and_Snapshots/snapshot_retention.md#create-snapshots-periodically).
...
!!! important "Snapshot Retention"
    ...
    [Snapshot Retention](../settings/Discovery_and_Snapshots/snapshot_retention.md) and
    [Schedule System Backup](../settings/system/Backup_and_Maintenance/system_backup.md).
