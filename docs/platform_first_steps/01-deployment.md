...
4. A `New virtual machine` dialog appears. In its 1st step `Select creation
   ...
   ![VMware ESXi - Create a new virtual machine](../images/miscellaneous/Cloud-install/miscellaneous-cloud-install_esxi-vmdk-create-vm.webp)
...
7. In the 4th step `Customize settings`:
   ...
   1. Remove the automatically added hard disk:
      ...
      ![VMware ESXi - Remove disk](../images/miscellaneous/Cloud-install/miscellaneous-cloud-install_esxi-vmdk-remove-disk.webp)

   2. Change the **SCSI Controller** to `VMware Paravirtual` (`PVSCSI`) and
      the **Adapter Type** under **Network Adapter** to `VMXNET 3`:

      ![VMware ESXi - Change storage and network](../images/miscellaneous/Cloud-install/miscellaneous-cloud-install_esxi-vmdk-storage-and-network.webp)

   3. Click **Add hard disk**, select **Existing hard disk**, and import the
      downloaded `ipfabric-<x.y.z+build>.vmdk` file:

      ![VMware ESXi - Add disk](../images/miscellaneous/Cloud-install/miscellaneous-cloud-install_esxi-vmdk-add-disk.webp)
...
2. In **Specify Name and Location**, define the VM name.
   ...
   ![Hyper-V - Specify Name and Location](../images/miscellaneous/Cloud-install/miscellaneous-cloud-install_hyperv-create.webp)

3. In **Specify Generation**, select **Generation 1**.

   ![Hyper-V - Specify Generation](../images/miscellaneous/Cloud-install/miscellaneous-cloud-install_hyperv-generation.webp)
...
4. In **Assign Memory**:
   ...
   ![Hyper-V - Assign Memory](../images/miscellaneous/Cloud-install/miscellaneous-cloud-install_hyperv-memory.webp)

5. In **Configure Networking**, select the appropriate **Virtual Switch**.

   ![Hyper-V - Configure Networking](../images/miscellaneous/Cloud-install/miscellaneous-cloud-install_hyperv-networking.webp)

6. In **Connect Virtual Hard Disk**:
   - Select **Use an existing virtual hard disk**.
   - Choose the decompressed `ipfabric-*.vhdx` file.

   ![Hyper-V - Connect Virtual Hard Disk](../images/miscellaneous/Cloud-install/miscellaneous-cloud-install_hyperv-harddisk.webp)

7. Review the **Summary** and click **Finish**.

   ![Hyper-V - Summary](../images/miscellaneous/Cloud-install/miscellaneous-cloud-install_hyperv-summary.webp)

8. After the VM is created, open **Settings**.

   ![Hyper-V - VM Settings](../images/miscellaneous/Cloud-install/miscellaneous-cloud-install_hyperv-settings.webp)
...
9. In **Processor**, configure the required number of vCPUs according to the
   ...
   ![Hyper-V - VM Settings - Hardware - Processor](../images/miscellaneous/Cloud-install/miscellaneous-cloud-install_hyperv-settings-cpu.webp)
...
2. In **Specify Name and Location**, define the VM name.
   ...
   ![Hyper-V - Specify Name and Location](../images/miscellaneous/Cloud-install/miscellaneous-cloud-install_hyperv-create-gen2.webp)

3. In **Specify Generation**, select **Generation 2**.

   ![Hyper-V - Specify Generation](../images/miscellaneous/Cloud-install/miscellaneous-cloud-install_hyperv-generation-2.webp)

4. In **Assign Memory**:
   - Configure memory according to the [Hardware Requirements](../overview/index.md#hardware-requirements).
   - You may use **Dynamic Memory** or assign fixed memory.

   ![Hyper-V - Assign Memory](../images/miscellaneous/Cloud-install/miscellaneous-cloud-install_hyperv-memory-gen2.webp)
...
6. In **Connect Virtual Hard Disk**:
   ...
   ![Hyper-V - Connect Virtual Hard Disk](../images/miscellaneous/Cloud-install/miscellaneous-cloud-install_hyperv-harddisk-gen2.webp)

7. Review the **Summary** and click **Finish**.

   ![Hyper-V - Summary](../images/miscellaneous/Cloud-install/miscellaneous-cloud-install_hyperv-summary-gen2.webp)
...
10. In **Security**, set **Secure Boot** to:
   ...
   ![Hyper-V - VM Settings - Security - Secure Boot](../images/miscellaneous/Cloud-install/miscellaneous-cloud-install_hyperv-secure-boot-gen2.webp)
...
3. Deploy the VM to your hypervisor with the `virt-install` utility. Replace the `--vcpu` and `--ram` values with the values your network size requires:
...
2.  Import the `OVA` image via **File --> Import Appliance...**:
    ...
    ![VirtualBox - Import Virtual Appliance](../images/miscellaneous/Cloud-install/miscellaneous-cloud-install_virtualbox-import-virtual-appliance.webp)
...
3.  In the next step of the **Import Virtual Appliance** guide:
    ...
    ![VirtualBox - Import Virtual Appliance - Appliance Settings](../images/miscellaneous/Cloud-install/miscellaneous-cloud-install_virtualbox-import-virtual-appliance-2.webp)
...
5.  In the **System** section, select `ICH9` as the **Chipset**:
    ...
    ![VirtualBox - VM Settings - System](../images/miscellaneous/Cloud-install/miscellaneous-cloud-install_virtualbox-vm-settings-system.webp)

6.  In the **Display** section, select `VMSVGA` as the **Graphics Controller**:

    ![VirtualBox - VM Settings - Display](../images/miscellaneous/Cloud-install/miscellaneous-cloud-install_virtualbox-vm-settings-display.webp)

    - Or to what VirtualBox suggests when an invalid Graphics Controller is selected:

    ![VirtualBox - VM Settings - Display - Invalid settings detected](../images/miscellaneous/Cloud-install/miscellaneous-cloud-install_virtualbox-vm-settings-display-2.webp)
...
7.  In the **Storage** section, select `virtio-scsi` as the Controller **Type**:
    ...
    ![VirtualBox - VM Settings - Storage](../images/miscellaneous/Cloud-install/miscellaneous-cloud-install_virtualbox-vm-settings-storage.webp)
...
8.  In the **Network** section, select `Bridged Adapter` and re-check in **Advanced** that the **Adapter Type** is `Paravirtualized Network (virtio-net)`:
    ...
    ![VirtualBox - VM Settings - Network](../images/miscellaneous/Cloud-install/miscellaneous-cloud-install_virtualbox-vm-settings-network.webp)
...
1. Log in to the [Microsoft Azure Portal](https://portal.azure.com/) and create or use an existing Resource Group.
   ...
   ![Create a Resource group](../images/miscellaneous/Cloud-install/miscellaneous-cloud-install_azure-01-create-resource-group.webp)
...
2. Create or use an existing Storage Account for the IP Fabric VM.
   ...
   ![Create a Storage account](../images/miscellaneous/Cloud-install/miscellaneous-cloud-install_azure-02-create-storage-account.webp)
...
3. Create or use an existing Blob Storage Container.
   ...
   ![Create a Blob Storage container](../images/miscellaneous/Cloud-install/miscellaneous-cloud-install_azure-03-storage-blob-container.webp)
...
5. [Upload the VHD image](https://learn.microsoft.com/en-us/azure/virtual-desktop/set-up-customize-master-image#upload-master-image-to-a-storage-account-in-azure) to the storage account blob container created using the [Azure Storage Explorer](https://azure.microsoft.com/en-us/products/storage/storage-explorer/).
   ...
   ![Upload the VHD image](../images/miscellaneous/Cloud-install/miscellaneous-cloud-install_azure-04-uploaded-vhd.webp)
...
4. Enter the CPU and RAM values from the [Hardware Requirements](../overview/index.md#hardware-requirements).
...
![Search Images](../images/miscellaneous/Cloud-install/miscellaneous-cloud-install_azure-05-1-images.webp)

Search and select `Images` in the portal's search bar, and then `Create` a new Image.

![Create an Image from VHD](../images/miscellaneous/Cloud-install/miscellaneous-cloud-install_azure-05-create-image.webp)
...
!!! warning "Azure Compute Gallery"
    ...
    ![Compute Gallery sharing method](../images/miscellaneous/Cloud-install/miscellaneous-cloud-install_azure-compgal-01.webp)

![Create Image Definition Pt.1](../images/miscellaneous/Cloud-install/miscellaneous-cloud-install_azure-imgdef-01.webp)

![Create Image Definition Pt.2](../images/miscellaneous/Cloud-install/miscellaneous-cloud-install_azure-imgdef-02.webp)
...
![Create VM](../images/miscellaneous/Cloud-install/miscellaneous-cloud-install_azure-06-create-vm.webp)

#### Basics

![VM Details](../images/miscellaneous/Cloud-install/miscellaneous-cloud-install_azure-07-vm-details.webp)

![Basics Continued](../images/miscellaneous/Cloud-install/miscellaneous-cloud-install_azure-08-basics-cont.webp)
...
![VM Networking](../images/miscellaneous/Cloud-install/miscellaneous-cloud-install_azure-10-networking.webp)
