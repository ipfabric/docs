...
![Current Snapshot drop-down menu](../images/snapshot-management/snapshot-management_overview-snapshot-selector-menu.webp)

## Snapshot Management

![Snapshot management overview](../images/snapshot-management/snapshot-management_overview-snapshot-management-overview.webp)
...
![Add Devices](../images/snapshot-management/snapshot-management_overview-snapshot-add-device.webp)

To refresh network state data for specific devices in an existing snapshot:

1. Select the devices you want to refresh:

   ![Selecting devices](../images/snapshot-management/snapshot-management_overview-snapshot-select-device.webp)

2. Click **Refresh Devices**:

   ![Refresh Devices](../images/snapshot-management/snapshot-management_overview-snapshot-refresh-device.webp)
...
2. Click **Delete Devices**:
   ...
   ![Delete Devices](../images/snapshot-management/snapshot-management_overview-snapshot-delete-device.webp)
