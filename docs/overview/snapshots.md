...
![Current Snapshot drop-down menu](../images/snapshot-management/overview_snapshot_selector_menu.webp)

## Snapshot Management

![Snapshot management overview](../images/snapshot-management/overview_snapshot_management_overview.webp)
...
![Add Devices](../images/snapshot-management/overview_snapshot_add_device.webp)

To refresh network state data for specific devices in an existing snapshot:

1. Select the devices you want to refresh:

   ![Selecting devices](../images/snapshot-management/overview_snapshot_select_device.webp)

2. Click **Refresh Devices**:

   ![Refresh Devices](../images/snapshot-management/overview_snapshot_refresh_device.webp)
...
2. Click **Delete Devices**:
   ...
   ![Delete Devices](../images/snapshot-management/overview_snapshot_delete_device.webp)
