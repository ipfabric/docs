...
![Current Snapshot drop-down menu](../images/snapshot-management/overview_snapshot_selector_menu.png)

## Snapshot Management

![Snapshot management overview](../images/snapshot-management/overview_snapshot_management_overview.png)
...
![Add Devices](../images/snapshot-management/overview_snapshot_add_device.png)

To refresh network state data for specific devices in an existing snapshot:

1. Select the devices you want to refresh:

   ![Selecting devices](../images/snapshot-management/overview_snapshot_select_device.png)

2. Click **Refresh Devices**:

   ![Refresh Devices](../images/snapshot-management/overview_snapshot_refresh_device.png)
...
2. Click **Delete Devices**:
   ...
   ![Delete Devices](../images/snapshot-management/overview_snapshot_delete_device.png)
