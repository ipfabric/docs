...
1. Make your changes in the **[Snapshot Settings](../../IP_Fabric_GUI/discovery_snapshot.md/#snapshot-specific-settings)** and then try to
   **Add Devices** (or `Rediscover timed out devices`). If these changes fixed
   ...
   ![Add devices](../../images/snapshot-management/snapshot-management_troubleshooting-add-devices.webp)
...
2. Make your changes globally and then run a new snapshot. In **Settings -->
   ...
   ![Limit discovery to subnet](../../images/snapshot-management/snapshot-management_troubleshooting-limit-discovery-to-subnet.webp)
...
![Discovery History](../../images/snapshot-management/snapshot-management_troubleshooting-discovery-history.webp)
...
![Advanced CLI](../../images/snapshot-management/snapshot-management_troubleshooting-advanced-cli.webp)
...
![Summary of Issues tab](../../images/snapshot-management/snapshot-management_troubleshooting-summary-of-issues.webp)
...
![Unmanaged Neighbors](../../images/snapshot-management/snapshot-management_troubleshooting-unmanaged-neighbors.webp)
...
![Unmanaged Neighbors Detail](../../images/snapshot-management/snapshot-management_troubleshooting-unmanaged-neighbors-detail.webp)
...
![Connectivity Report button](../../images/snapshot-management/errors/snapshot-management-errors_troubleshooting-connectivity-report-button.webp)
![Discovery Connectivity Report](../../images/snapshot-management/errors/snapshot-management-errors_troubleshooting-discovery-connectivity-report.webp)
...
![Configuration Management](../../images/snapshot-management/snapshot-management_troubleshooting-configuration-management.webp)
