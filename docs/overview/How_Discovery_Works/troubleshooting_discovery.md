...
1. Make your changes in the **[Snapshot Settings](../../IP_Fabric_GUI/discovery_snapshot.md/#snapshot-specific-settings)** and then try to
   **Add Devices** (or `Rediscover timed out devices`). If these changes fixed
   ...
   ![Add devices](../../images/snapshot-management/overview-How_Discovery_Works-troubleshooting_add_devices.webp)
...
2. Make your changes globally and then run a new snapshot. In **Settings -->
   ...
   ![Limit discovery to subnet](../../images/snapshot-management/overview-How_Discovery_Works-troubleshooting_limit_discovery_to_subnet.webp)
...
![Advanced CLI](../../images/snapshot-management/overview-How_Discovery_Works-troubleshooting_advanced_cli.webp)
...
![Vendors API](../../images/snapshot-management/overview-How_Discovery_Works-troubleshooting_vendors_api.webp)
...
![Device Credentials](../../images/snapshot-management/overview-How_Discovery_Works-troubleshooting_device_credentials.webp)
...
![Summary of Issues tab](../../images/snapshot-management/overview-How_Discovery_Works-troubleshooting_summary_of_issues.webp)
...
![Unmanaged Neighbors](../../images/snapshot-management/overview-How_Discovery_Works-troubleshooting_unmanaged_neighbors.webp)
...
![Unmanaged Neighbors Detail](../../images/snapshot-management/overview-How_Discovery_Works-troubleshooting_unmanaged_neighbors_detail.webp)
...
![Configuration Management](../../images/snapshot-management/overview-How_Discovery_Works-troubleshooting_configuration_management.webp)
