...
- `NIM-22351` -- Medium -- Aruba - 503H APs are not discovered - Backport to 7.3
...
- `NIM-22050` -- Highest -- EoL Filter - Unexpected Failure
...
- `NIM-21972` -- Highest -- Backport configuration export from 7.5 to 7.3
...
- `NIM-16748` -- Medium -- Add virtual wire support for Forcepoint
...
- `NIM-16947` -- Medium -- Implement manual link on API
- `NIM-16948` -- Medium -- Implement manual link on frontend - UI skeleton
- `NIM-16949` -- Medium -- Implement manual link in E2E
...
- `NIM-17446` -- Medium -- Update eEdge collection from manual link topology
...
- `NIM-17885` -- Medium -- Implement autocompletes on manual link form in Discovery Settings
- `NIM-17886` -- Medium -- Implement manual link on frontend - graphs
...
- `NIM-18225` -- High -- Implement manual link table with statuses in Snapshot Settings
- `NIM-18379` -- Medium -- Adding overrides to newly added ipv6 columns
- `NIM-18438` -- Medium -- Implement API endpoint for manual links to override snapshot settings with global settings
- `NIM-18456` -- Medium -- Preserve the messageType field in JSON log messages
- `NIM-18467` -- Medium -- Connect Override with global settings button to API on Snapshot Settings and provide final texts
...
- `NIM-18600` -- Medium -- Replace dummy page text and add feature flag to dedicated env file
