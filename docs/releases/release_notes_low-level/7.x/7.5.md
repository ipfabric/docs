...
- `NIM-22145` -- Highest -- Missing extensions after upgrade to 7.5
...
- `NIM-21896` -- High -- Cisco ios-xr - Saved config consistency - current config not available
...
- `NIM-22064` -- Highest -- pre-upgrade-check timed out after 60 seconds due to IPF checker I/O
...
- `NIM-21958` -- Highest -- Integrate pre-upgrade check with ipf-checker and use disk check as a gate for upgrade
...
- `NIM-17950` -- High -- Implement PostgresTaskerSetEdgeAzureExpressRouteDataProvider data provider [7.5]
...
- `NIM-18856` -- High -- Add support for F5OS - basic vendor discovery of chassis information [7.5]
...
- `NIM-18984` -- Medium -- Cloud subnets discovery [7.5]
...
- `NIM-19254` -- High -- Configuration import/export [7.5]
...
- `NIM-19949` -- Medium -- PSQL Correctness & Performance Testing [GA]
...
- `NIM-18921` -- Medium -- make links in diagram bi-directional
