...
- `NIM-21710` -- Medium -- [DP] Error "already exists in IP pools" when scanner subnet is in Exclude list
- `NIM-21774` -- High -- [DP] New scanner is also scanning local routes
...
- `NIM-23614` -- Highest -- [PP] Snapshot upload fails topology calculation with ENOENT
...
- `NIM-23192` -- Medium -- [PP] Temporarily emit finish jobs logs to the tasker logs for the 8.0
- `NIM-23198` -- Medium -- [PP] Discovery History
- `NIM-23209` -- Medium -- [PP] Process wlcApList in Tasker
- `NIM-23232` -- Medium -- [PP] Update documentation for the upcoming release about finish jobs
