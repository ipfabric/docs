...
- `NIM-23736` -- Highest -- CVE-2026-31431 – Kernel fix required for IPF builds
...
- `NIM-22249` -- Medium -- Cloud load balancers - Azure/AWS SSL certificates
- `NIM-22944` -- Medium -- MCP server responses optimization
- `NIM-23079` -- Medium -- MCP - Integrate MCP server into product
- `NIM-23090` -- Medium -- Remote and Secure MCP
...
- `NIM-22886` -- Medium -- Improve MCP server packaging
...
- `NIM-23279` -- Medium -- MCP - Setup debian package distribution
...
- `NIM-22215` -- Medium -- Meraki - add SD-WAN support
- `NIM-22586` -- Medium -- Discovery data contract basic design
- `NIM-22639` -- Medium -- Implement discovery data contract
- `NIM-22644` -- Medium -- Phase 1a: Get cloud resources using collector - routeTables
- `NIM-22645` -- Medium -- Azure - Virtual WAN (vWAN) - ExpRoute & VPN gateways
- `NIM-22658` -- Medium -- Phase 1a: Get cloud resources using collector - subnets
- `NIM-22737` -- Medium -- Joi to Zod migration - commands (per vendor)
- `NIM-22909` -- Medium -- GCP - support for classic VPN gateways
- `NIM-23068` -- Medium -- Meraki - IPSec support
- `NIM-23118` -- Medium -- D-Link support - DGS-1250 Series
- `NIM-23218` -- Medium -- Prepare environment for enforcement of data contract for tasks/ Validation migration to JSON Schema
...
- `NIM-23207` -- Highest -- Fix incorrect memory limitation for an API process
...
- `NIM-23410` -- Medium -- MCP - Replace terms of service placeholder
...
- `NIM-22355` -- High -- Add support for path-lookup via SDWAN
...
- `NIM-22723` -- Highest -- Move device storing code from updater into the backend (API)
- `NIM-22724` -- Medium -- Create a module to interact with the Object Storage
- `NIM-22729` -- Medium -- Implement Discovery API service
- `NIM-22751` -- Medium -- Update configuration management trigger to be used via Discovery API
- `NIM-22775` -- Medium -- Search field in new Discovery Settings
- `NIM-22858` -- Medium -- Appliance upgrade UI should allow independent updates of platform and discovery
- `NIM-22881` -- Medium -- Create Kafka connector module
...
- `NIM-22925` -- Medium -- Move updater queues related to scanworker and traceworker to tasker
- `NIM-22985` -- Medium -- Make contract JSON schemas available in products
- `NIM-22986` -- Medium -- Move tasks manipulation to Tasker
- `NIM-22995` -- Low -- Manage Kafka topics configuration through code
- `NIM-23009` -- Medium -- Synchronize artifacts and events topics for consumers
- `NIM-23011` -- Medium -- Handle discovery finished event in Platform
...
- `NIM-23082` -- Medium -- conditional db ingestion in updater
- `NIM-23083` -- Medium -- Produce life-cycle events in tasker into event-log
- `NIM-23088` -- High -- EOL intent checks no longer available in topology view
- `NIM-23113` -- Medium -- Auth strategies
...
- `NIM-23180` -- Medium -- Make snapshot load work with the new flow
- `NIM-23184` -- Medium -- Move trace cache calculation to Tasker
- `NIM-23192` -- Medium -- Temporarily emit finish jobs logs to the tasker logs for the 8.0
- `NIM-23198` -- Medium -- Discovery History
- `NIM-23209` -- Medium -- Process wlcApList in Tasker
- `NIM-23232` -- Medium -- Update documentation for the upcoming release about finish jobs
- `NIM-23249` -- Medium -- Meraki - IPSec - pathlookup/diagrams
- `NIM-23251` -- Medium -- Upgrade ipf-kafka to v4.2.0
- `NIM-23258` -- Medium -- Update dex to v2.45.1
- `NIM-23259` -- Medium -- Investigate CVEs
- `NIM-23260` -- Medium -- Read snapshot load data for specific snapshot
...
- `NIM-23332` -- Medium -- Create a CI pipeline that validates Kafka-related package updates
- `NIM-23356` -- Medium -- D-Link DGS-1250 - Enable mode
- `NIM-23361` -- Medium -- make sure contracts NPM package can be installed in pipelines
