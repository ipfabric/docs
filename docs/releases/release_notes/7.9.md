...
![release_7.9_ipv6_pathlookup.webp](../../images/diagrams/diagrams_release-7.9-ipv6-pathlookup.webp)
...
![release_7.9_cloud_routing_without_interface_in_e2e.webp](../../images/diagrams/diagrams_release-7.9-cloud-routing-without-interface-in-e2e.webp)
...
![AWS icons](../../images/miscellaneous/ipf/miscellaneous-ipf_aws-icons.webp)
![Azure icons](../../images/miscellaneous/ipf/miscellaneous-ipf_azure-icons.webp)
...
- An overview of active filters, with buttons to easily remove them, was added
  to all tables
  ![How Enhanced Filtering Works](../../images/inventory/devices/inventory-devices_release-notes-7-8-gui-filtering.webp).
...
For details, see [How To Upgrade IP Fabric via CLI](../../System_Administration/Command_Line_Interface/How_to/upgrade_CLI.md).
