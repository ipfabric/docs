...
#### User-Specific Saved Diagrams

Saved Diagrams are now user-specific and private to each user. Users can only view and manage their own saved diagrams.

!!! warning "Data Loss on User Deletion"

    If a user is deleted, all saved diagrams created by that user are permanently deleted and cannot be recovered. 
