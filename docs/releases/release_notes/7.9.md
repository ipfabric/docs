...
![release_7.9_ipv6_pathlookup.webp](../../images/diagrams/release_7.9_ipv6_pathlookup.webp)
...
![release_7.9_cloud_routing_without_interface_in_e2e.webp](../../images/diagrams/release_7.9_cloud_routing_without_interface_in_e2e.webp)
...
![AWS icons](../../images/miscellaneous/ipf/IP_Fabric_GUI-network-viewer-device-aws-icons.webp)
![Azure icons](../../images/miscellaneous/ipf/IP_Fabric_GUI-network-viewer-device-azure-icons.webp)
...
- An overview of active filters, with buttons to easily remove them, was added
  to all tables
  ![How Enhanced Filtering Works](../../images/inventory/devices/release_notes_7_8_gui_filtering.webp).
