...
![Upgrade options](../IP_Fabric_v6.x.x/6.10_upgrade_options.png)
...
![Authentication for 7.x upgrades](../IP_Fabric_v6.x.x/6.10_authenticate_for_7x_upgrades.jpg)
...
![Steps to upgrade system to 7.x](../IP_Fabric_v6.x.x/6.10_upgrades_to_7x_steps.png)
...
![Progress bar of the upgrade](../IP_Fabric_v6.x.x/6.10_progress_bar_of_upgrade.png)
