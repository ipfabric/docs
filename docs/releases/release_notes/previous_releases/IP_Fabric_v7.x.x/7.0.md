...
- **AWS Network Load Balancers support** -- data collection & E2E path lookup via NLB nodes for all listener types. Path lookup via AWS private link is not supported yet.
  ...
  !!! Warning "Don't forget to update IAM policy"
      ...
      In order to collect AWS Network Load Balancers, respective IAM policy has to be updated. You can download the new policy here.
...
![Upgrade options](../../../../images/miscellaneous/update_portal/releases-release_notes-previous_releases-IP_Fabric_v6.x.x_6.10_upgrade_options.webp)
...
![Authentication for 7.x upgrades](../../../../images/miscellaneous/update_portal/releases-release_notes-previous_releases-IP_Fabric_v6.x.x_6.10_authenticate_for_7x_upgrades.webp)
...
![Steps to upgrade system to 7.x](../../../../images/miscellaneous/update_portal/releases-release_notes-previous_releases-IP_Fabric_v6.x.x_6.10_upgrades_to_7x_steps.webp)
...
![Progress bar of the upgrade](../../../../images/miscellaneous/update_portal/releases-release_notes-previous_releases-IP_Fabric_v6.x.x_6.10_progress_bar_of_upgrade.webp)
