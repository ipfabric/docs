...
!!! danger "Upgrade Notice - Manual Links"

    If the optional feature `Manual Links` is enabled (see [Feature Flags](../../../../System_Administration/Command_Line_Interface/Feature_Flags.md)), you will need to remove all configured manual links from the global discovery settings prior to upgrading (see [Manual Links](../../../../IP_Fabric_Settings/Discovery_and_Snapshots/Discovery_Settings/manual_links.md)).
...
- Added support for F5 rSeries (F5OSA) and F5 VELOS (F5OSC) discovery.
  ...
  !!! warning "Do not forget to update IAM policy"
      ...
      You can download the new policy [here](../../../../IP_Fabric_Settings/Discovery_and_Snapshots/Discovery_Settings/Vendors_API/azure.md).
...
For migration instructions, please refer to the [Versioning](../../../../IP_Fabric_API/versioning.md#api-version-in-url-path-removed-in-v80) page.
