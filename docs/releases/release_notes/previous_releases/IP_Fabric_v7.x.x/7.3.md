...
![Disabled Discovery Tasks](../../../../images/miscellaneous/archive/miscellaneous-archive_7.2-disabled-task-list.webp)

![Disable Zone firewall discovery task for FortiGate](../../../../images/miscellaneous/archive/miscellaneous-archive_7.2-disabled-task-forti-zonefw.webp)

![Disable NAT44 discovery task for FortiGate](../../../../images/miscellaneous/archive/miscellaneous-archive_7.2-disabled-task-forti-nat44.webp)

## v7.3.26 (May 27th, 2026; GA)

```
SHA256 (ipfabric-update-7-3-26+0.tar.zst.sig) = 7e8c09c7e24badef4d31ad429a3ae7efa9e9a262ce2fc71ee2dc643719d9c445
MD5 (ipfabric-update-7-3-26+0.tar.zst.sig) = 4e9bdd4b25fa2e65e5169a1f14d91992
SHA256 (ipfabric-7-3-26+0.qcow2) = 67f5f0f5cb577f0728a72450f5379041b408467ac0573e12c2d8ef5b8680ad0f
MD5 (ipfabric-7-3-26+0.qcow2) = b44351b180fd11f1d0f722bb5a7100fb
SHA256 (ipfabric-7-3-26+0.vmdk) = 5f8398d4a65a649b6a7ae410df5184280a6a3c4d49d354de544b35cf0deaee24
MD5 (ipfabric-7-3-26+0.vmdk) = 7ab79fa50b93ec0ad9ae80154b9d5091
SHA256 (ipfabric-7-3-26+0.vhdx.zst) = 255e567282a42ec46b33171c5c113012e4b7c3f6d9b26355ee49892ed1227891
MD5 (ipfabric-7-3-26+0.vhdx.zst) = 9f1bcd3733e3d371012ae7fd58fec7dc
SHA256 (unsupported-ESXi6.7U2-ipfabric-7-3-26+0.ova) = 7536f71c89aafea03445648ea5ff399a15c5b299422b614d392854ec84621320
MD5 (unsupported-ESXi6.7U2-ipfabric-7-3-26+0.ova) = ab76f1bd03226ed04776a05a1dffabf7
SHA256 (unsupported-ESXi7.0-ipfabric-7-3-26+0.ova) = 9bc8511c2aa79c83b725959d9bfcf2f5f03b6d9acac9ade57cf0e24ffb74c77e
MD5 (unsupported-ESXi7.0-ipfabric-7-3-26+0.ova) = 9da70b392b643f51cdf47f2b64f953e1
SHA256 (ESXi8.0-ipfabric-7-3-26+0.ova) = d997e6a8d06ffbcef9b3b80f42e31886175868838de24243c29db946a3600970
MD5 (ESXi8.0-ipfabric-7-3-26+0.ova) = f95d33a1537a161d84c05d19f8e65246
```

### Security Patch

- Installed the newest security patches available for Debian 12.

## v7.3.25 (December 17th, 2025; GA)
...
- Corrected parsing of `ip helper-address` on Arista EOS devices so values are visible in technology tables.
- Fixed discovery of Aruba 503H access points.

## v7.3.24 (November 27th, 2025; GA)

### Bug Fixes

- Resolved syslog worker exiting when reaching the heap/memory limit.
- Fixed End-to-End Path Lookup performing double 'zoneFw' evaluation with different results on Fortinet devices.
- Resolved 'Unexpected Failure' when filtering on inventory/end-of-life-milestones/detail

## v7.3.23 (November 10th, 2025; GA)
...
- Added JSON output to ipf-checker
- [Configuration import/export feature](../../../../IP_Fabric_Settings/system/Backup_and_Maintenance/configuration_import_export.md) now also includes manual links, saved filters and views, graph views, path lookup checks and advanced options, and graph positions
...
- Fixed missing access points on Cisco WLC (wlc-air) platforms
- Fixed wired hosts not appearing in **Inventory --> Hosts** despite being present in ARP tables
- Fixed the `Status` column filter in **Management --> Configuration** so `no change` works correctly

## v7.3.22 (October 21th, 2025; GA)

### Improvements

- Path Lookup traffic values and loop detection.
- FortiGate and Cisco ACI E2E policy evaluation issues.
- Logging for Azure Vendor API tasks.

### Fixes

- GCP Inventory table loading error.
- Credential setup without username
- MAC address formatting and missing Juniper MAC table data.
...
- Processing of `show ip route detail full` commands on Cisco NX-OS has improved significantly.
...
!["Failed to load initial app data" error](../../../../images/miscellaneous/archive/miscellaneous-archive_7.2-app-data-error.webp){.center}

![License error](../../../../images/miscellaneous/archive/miscellaneous-archive_7.2-license-error.webp){.center}
...
- Announcing the deprecation of path-based versioning in the following release.
  More details can be found on the new [Versioning](../../../../IP_Fabric_API/versioning.md#api-version-in-url-path-removed-in-v80) page.
...
To collect Service Graph data, the feature flag `ENABLE_ACI_SERVICEGRAPHS_ENDPOINTS` must be enabled. For more information, see [feature flag documentation](../../../../System_Administration/Command_Line_Interface/Feature_Flags.md#aci-service-graphs-removed-in-711).
