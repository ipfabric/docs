...
- Added support for bulk actions on Vendor APIs (in both the global and
  ...
  ![Vendor API GUI with bulk actions](../../../../images/settings/discovery-snapshots/releases-release_notes-previous_releases-IP_Fabric_v6.x.x_6.4_vendor_api_bulk_actions.webp)
...
- AWS
  - **Update the related IAM policy prior to upgrading to `6.4`.** Download the
    policy JSON file IAM-policy-IPF_6.4.json.
