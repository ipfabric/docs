...
### New CIDR Operators for IPv4 Routing Table's `Route` Column
...
- The operators are available for the IPv4 routing table's `Route` column (e.g., in **Technology --> Routing --> Routes --> IPv4 Routes**).
