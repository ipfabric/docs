...
![Device JSON download](./6.9/JSON_download.webp)
...
![Discovery timestamps](./6.9/discovery-timestamps.webp)
...
![SDWAN Versa](./6.9/SDWAN_Versa.webp)
...
![Disabled Discovery Tasks](./6.9/disabled_task_list.webp)

![Disable Zone firewall discovery task for FortiGate](./6.9/disabled_task_forti_zonefw.webp)

![Disable NAT44 discovery task for FortiGate](./6.9/disabled_task_forti_nat44.webp)
