...
```
SHA256 (ipfabric-update-7-0-13+0.tar.zst.sig) = 2833c6f36d3653767b20babc8373d5010a931d3a70e315af3bc98924aec19a7f
MD5 (ipfabric-update-7-0-13+0.tar.zst.sig) = 3d20459604352f024caf434dd4dcd27d
SHA256 (ipfabric-7-0-13+0.ova) = f016bc77e6a450604c30da6470d231ea17ce75a1c4761816776085aeb024bb3b
MD5 (ipfabric-7-0-13+0.ova) = afed43cdc4e6145ddcf617e77f1526de
SHA256 (unsupported-sha1-ipfabric-7-0-13+0.ova) = 0d5da3a0d58df5b1c5110c26ccb47c99f2faccc3474ca94ac88db2d47ea20a2a
MD5 (unsupported-sha1-ipfabric-7-0-13+0.ova) = a782d545da4acd6590b9d95d53360c90
SHA256 (ipfabric-7-0-13+0.qcow2) = 1a8b40ff1ba897b4d43e3099005b71123118a3907e869608bfd06ca8f6b5bfda
MD5 (ipfabric-7-0-13+0.qcow2) = 58ff497db74e53a37da14c74e4c8b687
SHA256 (ipfabric-7-0-13+0.vmdk) = 451cdd25ff0370912c9a74216a6819b83330908ea320d2cc03b71092c4756e43
MD5 (ipfabric-7-0-13+0.vmdk) = c1e5fb8fe2997ebffc11846222ec32a4
SHA256 (ipfabric-7-0-13+0.vhdx.zst) = 3dc670ecc2434d3ee463016f5a830cef23c11089a59f7a3d4ef130d5a312b7cf
MD5 (ipfabric-7-0-13+0.vhdx.zst) = bfbba509863f5e612ddbeb2363e97ba4
```
...
!!! warning "Docker default subnet"
    Docker networking is configured with a virtual interface on the appliance and the default subnet is `172.17.0.0/16`.
    Devices in this subnet are not reachable from the appliance, because the routing is pointing towards the `docker` 
    bridge interface. If you must reach devices in this subnet, you need to change the default `docker` bridge
    subnet. See [how to change the default `docker` bridge subnet](../../support/known_issues/IP_Fabric/unable_to_discover_devices_in_172_17_0_0_16_subnet.md).
...
- Juniper devices with large IPv6 routing tables may cause issues during network discovery.
To mitigate the impact, lower the `Limit download BGP routes` setting in `/settings/discovery-snapshots/global-discovery-settings`.
