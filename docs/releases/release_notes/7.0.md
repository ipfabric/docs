...
```
SHA256 (ipfabric-update-7-0-14+0.tar.zst.sig) = cbedaf4b0d8d2d31b7e67bdfb5867dbb64a9d98a13fea86a87621619692e7b5d
MD5 (ipfabric-update-7-0-14+0.tar.zst.sig) = 652f6f136741df104eb4498acc0cac41
SHA256 (ipfabric-7-0-14+0.ova) = 18c32a6bf8002b40a32e3ff0da123524424800abd19da7719b05a8feb1d257d4
MD5 (ipfabric-7-0-14+0.ova) = 30d3869dace98ab28359fd9650f3bf5d
SHA256 (unsupported-sha1-ipfabric-7-0-14+0.ova) = a028c4ec5e9416832ab01b994b744e260cc8629cac6610b0865605d83269a47b
MD5 (unsupported-sha1-ipfabric-7-0-14+0.ova) = d3e56fbfed3fce4c9b5db10210582648
SHA256 (ipfabric-7-0-14+0.qcow2) = 0f5117f67888d75614118d32a095dbadb162e95f92725fe2c1dabfa0583fec70
MD5 (ipfabric-7-0-14+0.qcow2) = af93269a2cf113d48ec216be6ecb84c4
SHA256 (ipfabric-7-0-14+0.vmdk) = 7d0ba208b972d11b83664580f3e802af2dcecab48ba975c8332a1893f91cd4c9
MD5 (ipfabric-7-0-14+0.vmdk) = 83fa8402654786e9c97fc73198c70e1f
SHA256 (ipfabric-7-0-14+0.vhdx.zst) = ced2e831456d7adab5960878c19106d10c54a306780636fef9f3fae967378c9c
MD5 (ipfabric-7-0-14+0.vhdx.zst) = 93fb5d279fa88d3b0ee516438db7c4be
```

### Fixes

- The Docker service, which is used for extensions, was **disabled and stopped** due to conflicts between its default subnet (`172.17.0.0/16`) and
**networks used for discovery**. For more details, refer to the [Extensions section](#extensions-engineering-preview).
...
- The [BGP Threshold function](../../IP_Fabric_Settings/Discovery_and_Snapshots/Discovery_Settings/discovery/limit_download_of_bgp_routes.md) did not work
as expected on `JunOS` for `IPv6` addresses. When the function was disabled, routes were not downloaded, even though no limit should have been applied.
