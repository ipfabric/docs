...
![Upgrade options](previous_releases/IP_Fabric_v6.x.x/6.10_upgrade_options.webp)
...
![Authentication for 7.x upgrades](previous_releases/IP_Fabric_v6.x.x/6.10_authenticate_for_7x_upgrades.webp)
...
![Steps to upgrade system to 7.x](previous_releases/IP_Fabric_v6.x.x/6.10_upgrades_to_7x_steps.webp)
...
![Progress bar of the upgrade](previous_releases/IP_Fabric_v6.x.x/6.10_progress_bar_of_upgrade.webp)
