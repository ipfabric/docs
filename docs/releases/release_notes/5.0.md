...
!!! warning "Read All Upgrade Notices"
    ...
    This upgrade requires IP Fabric to be on `v4.4.3` prior to upgrade to `v5.0.0`.
...
!!! warning ""
    ...
    Documentation](../../../IP_Fabric_API/) page.

    `ipfabric` and `ipfabric-diagrams` Python SDK's have been updated to
    support the new changes. Please visit
    [python-ipfabric](https://github.com/community-fabric/python-ipfabric) and
...
!!! warning "SSO and API versioning"
    ...
    changes to your files prior to re-enabling. Before upgrading and you have
    SSO deployed please contact your Solution Architect to copy you custom
...
!!! important "RBAC phase 1"
    ...
    `5.0.1`. If you are planning on using Roles and API Tokens it is
...
- This upgrade requires IP Fabric to be on `v4.4.3` prior to upgrade to `v5.0.0`. IPFabric `v4.4.2` will or lower will not work -– please upgrade to `4.4.3` using the normal method before carrying out the `5.0.0` upgrade process.
...
- Prior to update please ensure you perform a [backup of your system](../../../System_Administration/Administrative_Interface/backup_and_restore/) or it is highly recommend to create a VM snapshot
...
- [Policies](../../../IP_Fabric_Settings/user_management/policies/)
...
- [Roles](../../../IP_Fabric_Settings/user_management/roles/)
    - A Role can consist of one or more policies
    - `admin` role cannot be changed or deleted
- [Users](../../../IP_Fabric_Settings/user_management/users/)
