...
To accelerate device configuration retrieval, enable [Git performance optimizations](../../System_Administration/Command_Line_Interface/Feature_Flags.md#configuration-management-optimizations) for configuration management.  
