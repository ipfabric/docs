...
We have introduced filtered BGP route collection support that allows network administrators to explicitly define which networks to collect. This enables focused BGP route analysis while optimizing system resources across Cisco IOS/IOS-XE, IOS-XR, NX-OS, Juniper JunOS, and Arista EOS platforms.
...
#### Just for testing - will be removed/revoked
