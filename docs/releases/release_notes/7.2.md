...
are now visible in path lookups. More details can be found in [IPsec & VXLAN tunnel endpoints](../../../IP_Fabric_GUI/diagrams/how_to_use_path-lookup/#ipsec-vxlan-tunnel-endpoints).
