...
!!! Info
    ...
    If you have defined `custom roles` in the 5.0 release, create a new **Attributes scope** policy to allow access to sites users need access to. Also define new **API Endpoints Scope** if needed. See, [Policies](../../settings/administration/policies.md).
