...
#### Initial transparent firewall support (behind feature flag)
  ...
  To enable this feature, the corresponding [feature flag](../../System_Administration/Command_Line_Interface/Feature_Flags.md#enable-manual-links--transparent-firewall-added-in-73) must be activated. Once enabled, transparent firewalls will appear in the **graph topology**, and **basic path lookup** (excluding security policy evaluation) will be supported.
