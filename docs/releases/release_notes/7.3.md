...
!!! danger "Before Upgrading to `v7.5` - Manual Links"

    If the optional
    [Enable Manual Links / Transparent Firewall](../../System_Administration/Command_Line_Interface/Feature_Flags.md#enable-manual-links-transparent-firewall)
    feature flag is enabled, remove all configured
    [manual links](../../IP_Fabric_Settings/Discovery_and_Snapshots/Discovery_Settings/manual_links.md)
    from the global discovery settings before you upgrade to `7.5`.
...
![Disabled Discovery Tasks](./7.2/7.2_disabled_task_list.webp)

![Disable Zone firewall discovery task for FortiGate](./7.2/7.2_disabled_task_forti_zonefw.webp)

![Disable NAT44 discovery task for FortiGate](./7.2/7.2_disabled_task_forti_nat44.webp)
...
!["Failed to load initial app data" error](7.2/7.2_app_data_error.webp){.center}

![License error](7.2/7.2_license_error.webp){.center}
