...
![Disabled Discovery Tasks](../../images/miscellaneous/archive/releases-release_notes-previous_releases-IP_Fabric_v7.x.x-7.2_7.2_disabled_task_list.png)

![Disable Zone firewall discovery task for FortiGate](../../images/miscellaneous/archive/releases-release_notes-previous_releases-IP_Fabric_v7.x.x-7.2_7.2_disabled_task_forti_zonefw.png)

![Disable NAT44 discovery task for FortiGate](../../images/miscellaneous/archive/releases-release_notes-previous_releases-IP_Fabric_v7.x.x-7.2_7.2_disabled_task_forti_nat44.png)
...
!["Failed to load initial app data" error](../../images/miscellaneous/archive/releases-release_notes-previous_releases-IP_Fabric_v7.x.x-7.2_7.2_app_data_error.png){.center}

![License error](../../images/miscellaneous/archive/releases-release_notes-previous_releases-IP_Fabric_v7.x.x-7.2_7.2_license_error.png){.center}
