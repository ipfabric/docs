...
- Added support for FabricPath end-to-end path lookup.
...
- Cisco Viptela -- When device isn't synchronized with vManage, information from configuration isn't downloaded.
