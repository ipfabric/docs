...
In previous versions, optional fields were omitted from certain API responses when not present. As of this release, optional fields are explicitly included with a `null` value if unset.
