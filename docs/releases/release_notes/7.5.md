...
!!! danger "Upgrade Notice - Manual Links"
    ...
    If the optional feature `Manual Links` is enabled (see [Enable Manual Links / Transparent Firewall](../../System_Administration/Command_Line_Interface/Feature_Flags.md#enable-manual-links-transparent-firewall)), you will need to remove all configured manual links from the global discovery settings prior to upgrading (see [Manual Links](../../IP_Fabric_Settings/Discovery_and_Snapshots/Discovery_Settings/manual_links.md)).
