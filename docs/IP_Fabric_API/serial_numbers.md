...
![Default view of Device Inventory table](serial_numbers/device_inventory_default_view.webp)
...
![Enable Unique serial number column](serial_numbers/enable_unique_serial_number_column.webp)

As expected, some devices have different values in their `Unique serial number`
and `Serial Number` columns:

![Comparison of Unique serial number and Serial Number columns](serial_numbers/comparison_of_columns.webp)
