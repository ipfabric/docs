...
![Default view of Device Inventory table](../images/inventory/IP_Fabric_API-serial_numbers_device_inventory_default_view.webp)
...
![Enable Unique serial number column](../images/inventory/IP_Fabric_API-serial_numbers_enable_unique_serial_number_column.webp)

As expected, some devices have different values in their `Unique serial number`
and `Serial Number` columns:

![Comparison of Unique serial number and Serial Number columns](../images/inventory/IP_Fabric_API-serial_numbers_comparison_of_columns.webp)
