...
- The data you need to have ready before running the script:
  ...
  - `IdP name`
    ...
    [SSO Button](../../images/settings/administration/ldap/settings-administration-ldap_sso_button_name.webp).
...
Logging can be found in `/opt/ipf-sso-setup-helper/log/`.
...
![Role ID](../../images/settings/administration/roles/settings-administration-roles_id.webp)
...
![Grant Access](../../images/settings/administration/ldap/settings-administration-ldap_sso_approval.webp)
...
![JSON YAML mapping](../../images/settings/administration/ldap/settings-administration-ldap_sso_api_dex_mapping.webp)
...
5. When the registration finishes, the Azure portal displays the app
   ...
   ![Azure App registration's Overview](../../images/settings/administration/ldap/settings-administration-ldap_azure-app-registration-overview.webp)
...
7. Enter a `Name` for the secret. E.g., `clientSecret`. **Make sure to copy and
   ...
   ![Azure App registration's Secret](../../images/settings/administration/ldap/settings-administration-ldap_azure-app-registration-secret.webp)
...
9. Find the `User.Read` permission (under `Microsoft Graph`) and grant it to the
   ...
   ![Azure AD API permissions](../../images/settings/administration/ldap/settings-administration-ldap_azure-api-permissions.webp)

10. From the **Token Configuration** menu, select `+ Add groups claim`:

    ![Azure AD token configuration](../../images/settings/administration/ldap/settings-administration-ldap_azure-token-configuration.webp)
