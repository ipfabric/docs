...
![Add local user button and Create User form](../../images/settings/IP_Fabric_Settings-administration-users_users_add_local.webp)
...
![Users table](../../images/settings/IP_Fabric_Settings-administration-users_users_table.webp)
...
1. To modify a local user's details or password, find the user in the `Users`
   ...
   ![Users table - edit local user](../../images/settings/IP_Fabric_Settings-administration-users_users_table_edit_local.webp)
...
3. Or, to modify the user's password, fill out the **Update Password** form and
   ...
   ![Edit local user](../../images/settings/IP_Fabric_Settings-administration-users_users_edit_local.webp)
...
1. To edit an LDAP/SSO user, find the user in the `Users` table and click the
   **Edit** icon. (Optionally, you may select `No` in the `Local user` column
   ...
   ![Users table - edit LDAP/SSO user](../../images/settings/IP_Fabric_Settings-administration-users_users_table_edit_ldap.webp)

2. Then, to modify the user's details, update the data in the **User Profile**
   form and click **Update user profile**:

   ![Edit LDAP/SSO user](../../images/settings/IP_Fabric_Settings-administration-users_users_edit_ldap.webp)
...
1. To delete a user, find the user in the `Users` table and click the **Delete**
   ...
   ![Users table - Delete icon](../../images/settings/IP_Fabric_Settings-administration-users_users_table_delete.webp)
