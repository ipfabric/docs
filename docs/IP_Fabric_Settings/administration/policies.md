...
1. To add a new policy, click **+ Add policy**:
   ...
   ![Add policy button](../../images/settings/IP_Fabric_Settings-administration-policies_policies_table.webp)

2. Click **Attributes scope**:

   ![Add policy - Attributes scope](../../images/settings/IP_Fabric_Settings-administration-policies_policies_attributes_add.webp)

3. Set a policy name, add attributes (create filters), select values, and click
   **Save**:

   ![Specify attributes scope policy](../../images/settings/IP_Fabric_Settings-administration-policies_policies_attributes_select.webp)
...
2. **API endpoints scope** should be selected by default:
   ...
   ![Add policy - API endpoints scope](../../images/settings/IP_Fabric_Settings-administration-policies_policies_endpoints_add.webp)

3. Set a policy name, select API endpoints, and click **Save**:

   ![Specify API endpoints scope policy](../../images/settings/IP_Fabric_Settings-administration-policies_policies_endpoints_select.webp)
...
![Policies table](../../images/settings/IP_Fabric_Settings-administration-policies_policies_table.webp)
...
1. To modify the details of a policy, click the **Edit** icon next to it in the
   ...
   ![Policies table - Edit icon](../../images/settings/IP_Fabric_Settings-administration-policies_policies_table_edit.webp)

2. Update the data in the **Edit policy** form and click **Save**:

   ![Edit policy form](../../images/settings/IP_Fabric_Settings-administration-policies_policies_edit.webp)

## Copy Policy

1. To copy a policy, click the **Copy** icon next to it in the `Policies` table:

   ![Policies table - Copy icon](../../images/settings/IP_Fabric_Settings-administration-policies_policies_table_copy.webp)

2. Update the data in the **Copy policy** form and click **Save**:

   ![Copy policy form](../../images/settings/IP_Fabric_Settings-administration-policies_policies_copy.webp)
...
1. To delete a policy, click the **Delete** icon next to it in the `Policies`
   ...
   ![Policies table - Delete icon](../../images/settings/IP_Fabric_Settings-administration-policies_policies_table_delete.webp)

2. To confirm the action, click **Delete**:

   ![Policy will be removed dialog](../../images/settings/IP_Fabric_Settings-administration-policies_policies_table_delete_confirm.webp)
