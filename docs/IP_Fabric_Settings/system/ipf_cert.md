...
!!! warning "Only Some Characters Are Allowed in Fields"
    ...
    **State / Province** must match the following regular expression:
    ...
    ![Organization and department fields](../../images/settings/system/ipfabric-certificates/IP_Fabric_Settings-system-ipf_cert_org_dep_fields.webp)
...
![Generate a CSR - Invalid Input](../../images/settings/system/ipfabric-certificates/IP_Fabric_Settings-system-ipf_cert_create_a_csr_invalid_input.webp)
...
1. Fill out the **Create a CSR (Certificate Signing Request)** form, but avoid
   ...
   ![Generate a CSR - with avoiding any special characters](../../images/settings/system/ipfabric-certificates/IP_Fabric_Settings-system-ipf_cert_create_a_csr_without_special_chars.webp)
...
7. Modify `customer.conf` (for example with `vi customer.conf`; in our example,
   ...
   ![Edit customer.conf file](../../images/settings/system/ipfabric-certificates/IP_Fabric_Settings-system-ipf_cert_edit_customer_conf_file.webp)
