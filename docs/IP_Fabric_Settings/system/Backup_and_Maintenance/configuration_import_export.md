...
![Export Configuration Button](../../../images/settings/system/backup-maintenance/settings-system-backup-maintenance_configuration_import_export_export_configuration_button.webp)
...
![Export Configuration UI](../../../images/settings/system/backup-maintenance/settings-system-backup-maintenance_configuration_import_export_export_configuration.webp)
...
![Export Configuration Download](../../../images/settings/system/backup-maintenance/settings-system-backup-maintenance_configuration_import_export_export_configuration_download.webp)

## Configuration Import

To import the configuration, follow these steps and click the **Import Configuration** button.

![Import Configuration Button](../../../images/settings/system/backup-maintenance/settings-system-backup-maintenance_configuration_import_export_import_configuration_button.webp)
...
![Import Configuration UI](../../../images/settings/system/backup-maintenance/settings-system-backup-maintenance_configuration_import_export_import_configuration.webp)
