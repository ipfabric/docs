...
![Schedule local backup](../../../images/settings/system/backup-maintenance/settings-system-backup-maintenance_system_backup_schedule_local_backup.webp)
...
4. Set a backup schedule. See the example for `Every day at 5:15 and 17:15` (to
   ...
   ![Backup schedule](../../../images/settings/system/backup-maintenance/settings-system-backup-maintenance_system_backup_backup_schedule.webp)
