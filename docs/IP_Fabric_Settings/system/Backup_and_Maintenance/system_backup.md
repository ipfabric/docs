...
![Schedule local backup](../../../images/settings/IP_Fabric_Settings-system-Backup_and_Maintenance-system_backup_schedule_local_backup.png)
...
4. Set a backup schedule. See the example for `Every day at 5:15 and 17:15` (to
   ...
   ![Backup schedule](../../../images/settings/IP_Fabric_Settings-system-Backup_and_Maintenance-system_backup_backup_schedule.png)
