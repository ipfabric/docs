...
![Clear DB](../../../images/settings/system/backup-maintenance/settings-system-backup-maintenance_cleardb_cleardb.webp)

There are two-way confirmations.

![First confirmation](../../../images/settings/system/backup-maintenance/settings-system-backup-maintenance_cleardb_cleardb_first_confirmation.webp)

In the second screen, you can choose between **Reset Settings** and **Keep
Settings**:

![Second confirmation](../../../images/settings/system/backup-maintenance/settings-system-backup-maintenance_cleardb_cleardb_second_confirmation.webp)
