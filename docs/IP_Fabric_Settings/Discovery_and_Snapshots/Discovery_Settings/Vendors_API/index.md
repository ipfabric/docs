...
![Slug and Comment](../../../../images/settings/discovery-snapshots/settings-discovery-snapshots_Vendors_API_slug_and_comment.webp)
...
![Proxy and certificates settings](../../../../images/settings/discovery-snapshots/settings-discovery-snapshots_Vendors_API_proxy_and_certificates_settings.webp)
...
![Show advanced settings](../../../../images/settings/discovery-snapshots/settings-discovery-snapshots_Vendors_API_show_advanced_settings.webp)

These are the default values for `Meraki REST`:

![Advanced settings for Meraki REST](../../../../images/settings/discovery-snapshots/settings-discovery-snapshots_Vendors_API_advanced_settings_for_meraki_rest.webp)
