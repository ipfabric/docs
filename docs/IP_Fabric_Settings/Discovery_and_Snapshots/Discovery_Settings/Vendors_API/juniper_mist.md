...
1. Log in to the [Juniper Mist website](https://manage.mist.com/signin.html#!signin):
   ...
   ![Juniper Mist login page](../../../../images/settings/discovery-snapshots/settings-discovery-snapshots_mist_mist_login.webp)

   ![Juniper Mist main GUI](../../../../images/settings/discovery-snapshots/settings-discovery-snapshots_mist_mist_gui.webp)
...
2. Once logged in, open a new tab in the same browser and go to the [API token generation](https://api.mist.com/api/v1/self/apitokens) page:
   ...
   ![Create API token](../../../../images/settings/discovery-snapshots/settings-discovery-snapshots_mist_mist_api_token.webp)

3. Once generated, the API token can be used in the IP Fabric GUI.

   ![Create API token - copy generated API token](../../../../images/settings/discovery-snapshots/settings-discovery-snapshots_mist_mist_api_create.webp)
...
4. In the IP Fabric GUI, go to **Settings --> Discovery & Snapshots -->
   ...
   ![Add Connection - Juniper Mist](../../../../images/settings/discovery-snapshots/settings-discovery-snapshots_mist_mist_ipf_settings.webp)
