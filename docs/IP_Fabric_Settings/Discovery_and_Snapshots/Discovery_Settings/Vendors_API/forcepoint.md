...
1. Log in to the Forcepoint SMC web UI.
   ...
   ![Forcepoint login page](../../../../images/settings/IP_Fabric_Settings-Discovery_and_Snapshots-Discovery_Settings-Vendors_API-forcepoint-smc_forcepoint_login_page.png)
...
2. Generate API tokens:
   ...
   ![Location where to generate new API key](../../../../images/settings/IP_Fabric_Settings-Discovery_and_Snapshots-Discovery_Settings-Vendors_API-forcepoint-smc_forcepoint_generate_api_token.png)
...
3. Add a name for the newly created entry and **copy the token**. Once the settings are saved, the **token will be hidden**. Also, add read-access privileges.
   ...
   ![Create new API key](../../../../images/settings/IP_Fabric_Settings-Discovery_and_Snapshots-Discovery_Settings-Vendors_API-forcepoint-smc_forcepoint_generate_token.png)
...
4. The API endpoint needs to be enabled explicitly, as it is disabled by default:
   ...
   ![Enable SMC API](../../../../images/settings/IP_Fabric_Settings-Discovery_and_Snapshots-Discovery_Settings-Vendors_API-forcepoint-smc_forcepoint_enable_api.png)
...
- [**Slug**](index.md#slug-and-comment)
  ...
  ![Add Connection - Forcepoint](../../../../images/settings/IP_Fabric_Settings-Discovery_and_Snapshots-Discovery_Settings-Vendors_API-forcepoint-smc_forcepoint_ipf_add_vendor.png)
