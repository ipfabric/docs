...
1. Log in to the Forcepoint SMC web UI.
   ...
   ![Forcepoint login page](../../../../images/settings/discovery-snapshots/IP_Fabric_Settings-Discovery_and_Snapshots-Discovery_Settings-Vendors_API-forcepoint-smc_forcepoint_login_page.webp)
...
2. Generate API tokens:
   ...
   ![Location where to generate new API key](../../../../images/settings/discovery-snapshots/IP_Fabric_Settings-Discovery_and_Snapshots-Discovery_Settings-Vendors_API-forcepoint-smc_forcepoint_generate_api_token.webp)
...
3. Add a name for the newly created entry and **copy the token**. Once the settings are saved, the **token will be hidden**. Also, add read-access privileges.
   ...
   ![Create new API key](../../../../images/settings/discovery-snapshots/IP_Fabric_Settings-Discovery_and_Snapshots-Discovery_Settings-Vendors_API-forcepoint-smc_forcepoint_generate_token.webp)
...
4. The API endpoint needs to be enabled explicitly, as it is disabled by default:
   ...
   ![Enable SMC API](../../../../images/settings/discovery-snapshots/IP_Fabric_Settings-Discovery_and_Snapshots-Discovery_Settings-Vendors_API-forcepoint-smc_forcepoint_enable_api.webp)
...
- [**Slug**](index.md#slug-and-comment)
  ...
  ![Add Connection - Forcepoint](../../../../images/settings/discovery-snapshots/IP_Fabric_Settings-Discovery_and_Snapshots-Discovery_Settings-Vendors_API-forcepoint-smc_forcepoint_ipf_add_vendor.webp)
