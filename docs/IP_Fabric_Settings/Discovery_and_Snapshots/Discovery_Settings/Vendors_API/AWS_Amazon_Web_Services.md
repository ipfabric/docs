...
![AWS Management Console](../../../../images/settings/discovery-snapshots/settings-discovery-snapshots_aws_aws-management-console.webp)

Click `My Security Credentials` and open the `Access keys` tab.

![AWS - Your Security Credentials](../../../../images/settings/discovery-snapshots/settings-discovery-snapshots_aws_aws-your-security-credentials.webp)
...
![AWS - Create Access Key](../../../../images/settings/discovery-snapshots/settings-discovery-snapshots_aws_aws-create-access-key.webp)
...
![Add Connection](../../../../images/settings/discovery-snapshots/settings-discovery-snapshots_aws_aws-vendor-api.webp)
...
- **Simplified policy**
  - File: [IAM-policy-IPF_simplified_8.1_or_newer.json](aws/IAM-policy-IPF_simplified_8.1_or_newer.json)
  - Uses wildcard action matching
  - Easier to maintain
  - Compatible with all supported versions

- **Granular policy**
  - File: [IAM-policy-IPF_8.1-full.json](aws/IAM-policy-IPF_8.1-full.json)
...
![Add Connection with AssumeRole](../../../../images/settings/discovery-snapshots/settings-discovery-snapshots_aws_aws-assumerole.webp)
...
!!! warning "Connection Testing Limitation"
    ...
    ![AWS - Connection testing limitation](../../../../images/settings/discovery-snapshots/settings-discovery-snapshots_aws_aws_connection_test_limit.webp)
