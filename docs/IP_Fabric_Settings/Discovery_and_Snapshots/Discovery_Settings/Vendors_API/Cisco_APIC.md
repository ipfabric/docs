   ...
   - [**Slug**](index.md#slug-and-comment) (optional).
    ...
    ??? info "Username if Local Domain Is Set on the APIC"
        ...
        **Username** for IP Fabric settings is:
        ...
        ```
        ![APIC login screen](../../../../images/settings/discovery-snapshots/settings-discovery-snapshots_Vendors_API_apic_local_domain.webp)
        ![IP Fabric settings - Username](../../../../images/settings/discovery-snapshots/settings-discovery-snapshots_Vendors_API_local_domain_apic_ipf_settings.webp)

5. Click **Save** to add the configuration.

![Add Connection - Cisco APIC](../../../../images/settings/discovery-snapshots/settings-discovery-snapshots_apic_ciscoApicAPIAdd.webp)
