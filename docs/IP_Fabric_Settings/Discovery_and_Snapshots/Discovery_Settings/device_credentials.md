...
![Add new CLI credential](../../../images/settings/discovery-snapshots/settings-discovery-snapshots_add-new-cli-credential.webp)
...
![Passwords for enable mode](../../../images/settings/discovery-snapshots/settings-discovery-snapshots_passwords-for-enable-mode.webp)
