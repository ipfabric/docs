...
!!! Example "Regex Based on Hostname Using Default Option"
    ...
    ![Hostname regex: default site name](../../../images/settings/discovery-snapshots/settings-discovery-snapshots_site_separation_hostname_regex_default.webp)
...
!!! Example "Regex Based on Hostname Using Customized Site Name"
    ...
    ![Hostname regex: custom site name](../../../images/settings/discovery-snapshots/settings-discovery-snapshots_site_separation_hostname_regex_custom.webp)
...
![SNMP regex](../../../images/settings/discovery-snapshots/settings-discovery-snapshots_site_separation_snmp_regex.webp)
...
!!! Example "Cloud Resource ID Site Sepatation"
    ...
    ![Cloud Resource ID](../../../images/settings/discovery-snapshots/settings-discovery-snapshots_site_separation_cloud_resource_aws_region_custom.webp)
...
![Testing hostname regex](../../../images/settings/discovery-snapshots/settings-discovery-snapshots_site_separation_testing_hostname.webp)

You can also test SNMP location rules:

![Testing SNMP location regex](../../../images/settings/discovery-snapshots/settings-discovery-snapshots_site_separation_testing_snmp.webp)
...
![Device Neighborship](../../../images/settings/discovery-snapshots/settings-discovery-snapshots_site_separation_device_neighborship.webp)
...
![Configure device attributes](../../../images/settings/discovery-snapshots/settings-discovery-snapshots_site_separation_configure_device_attributes.webp)

!!! info "New Design"

    Since version 7.10, we are testing a new design of Discovery Settings.

    ![Configure device attributes - New Design](../../../images/settings/discovery-snapshots/settings-discovery-snapshots_site_separation_configure_device_attributes2.webp)

or go to **Settings --> Discovery & Snapshots --> Global Configuration --> Device Attributes**:

![Device Attributes menu](../../../images/settings/discovery-snapshots/settings-discovery-snapshots_site_separation_device_attributes_menu.webp)

### Device Attributes

![Device Attributes table](../../../images/settings/discovery-snapshots/settings-discovery-snapshots_site_separation_device_attributes_table.webp)
...
![Add Attribute](../../../images/settings/discovery-snapshots/settings-discovery-snapshots_site_separation_add_attribute.webp)

![Dropdown](../../../images/settings/discovery-snapshots/settings-discovery-snapshots_site_separation_dropdown.webp)
...
![Rule priority](../../../images/settings/discovery-snapshots/settings-discovery-snapshots_site_separation_rule_priority.webp)
