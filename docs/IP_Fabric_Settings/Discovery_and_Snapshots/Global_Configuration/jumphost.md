...
2. On the page, click **+ Add**:
   ...
   ![Add button](../../../images/settings/discovery-snapshots/IP_Fabric_Settings-Discovery_and_Snapshots-Global_Configuration-jumphost_add_button.webp)

3. Fill in all necessary data:

   ![Add Jumphost form](../../../images/settings/discovery-snapshots/IP_Fabric_Settings-Discovery_and_Snapshots-Global_Configuration-jumphost_add_jumphost_form.webp)
...
5. If the connection is open, you will see `Yes` in the `Status` column in the
   ...
   ![Jumphost settings table - Yes status for jumphost](../../../images/settings/discovery-snapshots/IP_Fabric_Settings-Discovery_and_Snapshots-Global_Configuration-jumphost_jumphost_settings_table.webp)
...
1. Download the SSH key from Jumphost settings:
   ...
   ![Download public key button](../../../images/settings/discovery-snapshots/IP_Fabric_Settings-Discovery_and_Snapshots-Global_Configuration-jumphost_download_public_key_button.webp)
...
1. Edit the configuration that needs to be disabled, i.e.:
   ...
   ![Edit icon](../../../images/settings/discovery-snapshots/IP_Fabric_Settings-Discovery_and_Snapshots-Global_Configuration-jumphost_edit_icon.webp)

2. Change the setting to `Disabled`.

3. Click **Update**.

   ![Disable jumphost](../../../images/settings/discovery-snapshots/IP_Fabric_Settings-Discovery_and_Snapshots-Global_Configuration-jumphost_disable_jumphost.webp)
...
2. Click **Delete**.
   ...
   ![Delete jumphost](../../../images/settings/discovery-snapshots/IP_Fabric_Settings-Discovery_and_Snapshots-Global_Configuration-jumphost_delete_jumphost.webp)
...
7. Make a screenshot or copy the settings of the old jumphost. Then, delete or
   ...
   ![Jumphost settings - edit or delete](../../../images/settings/discovery-snapshots/IP_Fabric_Settings-Discovery_and_Snapshots-Global_Configuration-jumphost_jumphost_delete_settings.webp)
...
8. Put the **IP address/subnet of the IP Fabric machine** to **Exclude IPv4
   ...
   ![Add IP Fabric VM's IP address to jumphost's exclude list](../../../images/settings/discovery-snapshots/IP_Fabric_Settings-Discovery_and_Snapshots-Global_Configuration-jumphost_jumphost_exclude.webp)
