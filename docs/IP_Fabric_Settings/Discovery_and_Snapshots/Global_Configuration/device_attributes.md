...
![Attribute field warning](../../../images/settings/discovery-snapshots/settings-discovery-snapshots_device_attributes_device_attributes_warning.webp)
...
![Device Attributes table](../../../images/settings/discovery-snapshots/settings-discovery-snapshots_device_attributes_device_attributes.webp)
...
![Device Attributes - create rule](../../../images/settings/discovery-snapshots/settings-discovery-snapshots_device_attributes_device_attributes_rules.webp)

The dropdown is intuitive and will let you search based on SN or hostname.

![Device Attributes - dropdown](../../../images/settings/discovery-snapshots/settings-discovery-snapshots_device_attributes_device_attributes_dropdown.webp)
...
![Device Attributes Import/Export](../../../images/settings/discovery-snapshots/settings-discovery-snapshots_device_attributes_device_attributes_import_export.webp)
